-- Migration 57: Fix start_quiz_attempt RPC for dual-model enrollments
...
BEGIN
    ...
    -- 3. Enrollment Check using Helpers
    v_is_enrolled := false;
    ...
    -- Admins/Teachers could also start quizzes for previewing
