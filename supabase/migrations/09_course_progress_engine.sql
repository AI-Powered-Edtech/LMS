...
-- 2. Drop legacy schema that relies on the old course_progress definition
DROP MATERIALIZED VIEW IF EXISTS public.course_analytics_mv CASCADE;
...
-- 6. Recreate Materialized View for Analytics
