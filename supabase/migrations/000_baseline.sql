-- =============================================================================
-- EduSync LMS — Migration 000: Complete Schema Baseline
-- =============================================================================
-- Generated: 2026-03-21
-- Source: pg_dump of production-equivalent Supabase project
--         (consolidated from migrations 001–840)
--
-- This single file replaces 181 individual migration files.
-- All prior migrations are archived in supabase/migrations/_archive/
--
-- Schema summary:
--   - 84 tables (all tenant-scoped via tenant_id + RLS)
--   - 194 RLS policies
--   - 213 SQL functions / RPCs
--   - Extensions: uuid-ossp, pgcrypto, pg_cron, pg_net, pg_graphql
--
-- Run via: supabase db reset  (applies this file then supabase/seed.sql)
-- =============================================================================
