...
- sql | 002_auth_replacement_functions.sql |
- sql | 003_invitations_and_memberships.sql |
- sql | 004_create_ai_tutor_sessions.sql |
- sql | 005_create_lti_tables.sql |
- sql | 006_add_realtime_triggers.sql |
- sql | 007_add_storage_tracking.sql |
- sql | 008_tighten_rls_for_vil.sql |
- sql | 009_drop_rls.sql |
- sql | 012_video_transcoding_jobs.sql |
- sql | 013_export_jobs.sql |
- sql | 014_gradebook_realtime_triggers.sql |
- sql | 015_backend_heavy_tables.sql |
- sql | 016_add_performance_indexes.sql |
- sql | 017_add_google_id_to_profiles.sql |
- sql | 018_fix_backend_schema_bugs.sql |
- sql | 019_audit_fixes.sql |
- sql | 020_fix_rpc_signatures.sql |
- sql | 021_rpc_json.sql |
- sql | 022_align_table_columns.sql |
- sql | 023_rpc_stubs.sql |
- sql | 024_course_review_workflow.sql |
- sql | 025_personal_and_multi_tenant.sql |
- sql | 026_join_code_and_slugify.sql |
- sql | 027_p2_backlog.sql |
- sql | 028_p3_tenant_settings_and_roles.sql |
- sql | 029_add_admin_notification_types.sql |
- sql | 030_admin_stub_tables_and_rpcs.sql |
- sql | 031_qa_schema_gaps.sql |
- sql | 032_qa_rpcs.sql |
- sql | 033_fix_search_questions_return_json.sql |
- sql | 034_lesson_progress_monitor_rpc.sql |
- sql | 035_admin_backfill.sql |
- sql | 036_confirm_demo_seed_users.sql |
- sql | 037_qa_sweep_fixes.sql |
- sql | 037_seed_modules_missing_rpcs_and_auth_uid.sql |
- sql | 038_fix_get_tenant_users_user_id_alias.sql |
- sql | 039_academic_years.sql |
- sql | 040_semesters_link_academic_year.sql |
- sql | 041_grade_levels.sql |
- sql | 042_rombel.sql |
- sql | 043_subjects_and_curriculum_items.sql |
- sql | 044_timetable_slots.sql |
- sql | 045_dossiers.sql |
- sql | 046_rbac_10_role_matrix.sql |
- sql | 047_cp_tagging.sql |
- sql | 048_gradebook_dual_mode.sql |
- sql | 049_nilai_per_cp.sql |
- sql | 050_akm_question_type.sql |
- sql | 051_p5_module.sql |
- sql | 052_domain_events_outbox.sql |
- sql | 053_rapor_kurmer.sql |
- sql | 054_finance_midtrans.sql |
- sql | 055_bos_expense_tracking.sql |
- sql | 056_ppdb_flow.sql |
- sql | 057_integrations.sql |
- sql | 058_ai_polish.sql |
- sql | 059_audit_rate_limit_perf.sql |
- sql | 060_counseling_parent_links_sikap.sql |
- sql | 061_app_audit_triggers.sql |
- sql | 062_rapor_autogen_rpc.sql |
- sql | 063_rombel_attendance.sql |
- sql | 064_stub_tables.sql |
- sql | 065_gradebook_baseline.sql |
- sql | 066_role_enum_completeness.sql |
- sql | 067_idempotent_auto_modules.sql |
- sql | 068_sync_user_roles_to_granular.sql |
- sql | 069_classes_rombel_id.sql |
- sql | 070_event_handler_idempotency.sql |
- sql | 071_ai_rate_limit.sql |
- sql | 072_parent_invoices_rpc.sql |
- sql | 073_refresh_tokens_session_metadata.sql |
- sql | 074_tenant_invites_and_settings.sql |
- sql | 075_tenant_invites_global_unique_code.sql |
- sql | 076_invalidate_refresh_tokens_post_rotation.sql |
- sql | 077_plagiarism_checks.sql |
- sql | 078_scorm_runtime_data.sql |
