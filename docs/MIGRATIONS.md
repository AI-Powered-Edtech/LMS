...
| 018_fix_backend_schema_bugs.sql | undocumented |
| 019_audit_fixes.sql | undocumented |
| 020_fix_rpc_signatures.sql | undocumented |
| 021_rpc_json.sql | undocumented |
| 022_align_table_columns.sql | undocumented |
| 023_rpc_stubs.sql | undocumented |
| 024_course_review_workflow.sql | undocumented |
| 025_personal_and_multi_tenant.sql | undocumented |
| 026_join_code_and_slugify.sql | undocumented |
| 027_p2_backlog.sql | undocumented |
| 028_p3_tenant_settings_and_roles.sql | undocumented |
| 029_add_admin_notification_types.sql | undocumented |
| 030_admin_stub_tables_and_rpcs.sql | undocumented |
| 031_qa_schema_gaps.sql | undocumented |
| 032_qa_rpcs.sql | undocumented |
| 033_fix_search_questions_return_json.sql | undocumented |
| 034_lesson_progress_monitor_rpc.sql | undocumented |
| 035_admin_backfill.sql | undocumented |
| 036_confirm_demo_seed_users.sql | undocumented |
| 037_qa_sweep_fixes.sql | undocumented |
| 037_seed_modules_missing_rpcs_and_auth_uid.sql | undocumented |
| 038_fix_get_tenant_users_user_id_alias.sql | undocumented |
| 039_academic_years.sql | undocumented |
| 040_semesters_link_academic_year.sql | undocumented |
| 041_grade_levels.sql | undocumented |
| 042_rombel.sql | undocumented |
| 043_subjects_and_curriculum_items.sql | undocumented |
| 044_timetable_slots.sql | undocumented |
| 045_dossiers.sql | undocumented |
| 046_rbac_10_role_matrix.sql | undocumented |
| 047_cp_tagging.sql | undocumented |
| 048_gradebook_dual_mode.sql | undocumented |
| 049_nilai_per_cp.sql | undocumented |
| 050_akm_question_type.sql | undocumented |
| 051_p5_module.sql | undocumented |
| 052_domain_events_outbox.sql | undocumented |
| 053_rapor_kurmer.sql | undocumented |
| 054_finance_midtrans.sql | undocumented |
| 055_bos_expense_tracking.sql | undocumented |
| 056_ppdb_flow.sql | undocumented |
| 057_integrations.sql | undocumented |
| 058_ai_polish.sql | undocumented |
| 059_audit_rate_limit_perf.sql | undocumented |
| 060_counseling_parent_links_sikap.sql | undocumented |
| 061_app_audit_triggers.sql | undocumented |
| 062_rapor_autogen_rpc.sql | undocumented |
| 063_rombel_attendance.sql | undocumented |
| 064_stub_tables.sql | undocumented |
| 065_gradebook_baseline.sql | undocumented |
| 066_role_enum_completeness.sql | undocumented |
| 067_idempotent_auto_modules.sql | undocumented |
| 068_sync_user_roles_to_granular.sql | undocumented |
| 069_classes_rombel_id.sql | undocumented |
| 070_event_handler_idempotency.sql | undocumented |
| 071_ai_rate_limit.sql | undocumented |
| 072_parent_invoices_rpc.sql | undocumented |
| 073_refresh_tokens_session_metadata.sql | undocumented |
| 074_tenant_invites_and_settings.sql | undocumented |
| 075_tenant_invites_global_unique_code.sql | undocumented |
| 076_invalidate_refresh_tokens_post_rotation.sql | undocumented |
| 077_plagiarism_checks.sql | undocumented |
| 078_scorm_runtime_data.sql | undocumented |