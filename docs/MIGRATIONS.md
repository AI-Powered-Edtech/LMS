...
- sql | 018_fix_backend_schema_bugs.sql | documented
- sql | 019_audit_fixes.sql | documented
- sql | 020_fix_rpc_signatures.sql | documented
- sql | 021_rpc_json.sql | documented
- sql | 022_align_table_columns.sql | documented
- sql | 023_rpc_stubs.sql | documented
- sql | 024_course_review_workflow.sql | documented
- sql | 025_personal_and_multi_tenant.sql | documented
- sql | 026_join_code_and_slugify.sql | documented
- sql | 027_p2_backlog.sql | documented
- sql | 028_p3_tenant_settings_and_roles.sql | documented
- sql | 029_add_admin_notification_types.sql | documented
- sql | 030_admin_stub_tables_and_rpcs.sql | documented
- sql | 031_qa_schema_gaps.sql | documented
- sql | 032_qa_rpcs.sql | documented
- sql | 033_fix_search_questions_return_json.sql | documented
- sql | 034_lesson_progress_monitor_rpc.sql | documented
- sql | 035_admin_backfill.sql | documented
- sql | 036_confirm_demo_seed_users.sql | documented
- sql | 037_qa_sweep_fixes.sql | documented
- sql | 037_seed_modules_missing_rpcs_and_auth_uid.sql | documented
- sql | 038_fix_get_tenant_users_user_id_alias.sql | documented
- sql | 039_academic_years.sql | documented
- sql | 040_semesters_link_academic_year.sql | documented
- sql | 041_grade_levels.sql | documented
- sql | 042_rombel.sql | documented
- sql | 043_subjects_and_curriculum_items.sql | documented
- sql | 044_timetable_slots.sql | documented
- sql | 045_dossiers.sql | documented
- sql | 046_rbac_10_role_matrix.sql | documented
- sql | 047_cp_tagging.sql | documented
- sql | 048_gradebook_dual_mode.sql | documented
- sql | 049_nilai_per_cp.sql | documented
- sql | 050_akm_question_type.sql | documented
- sql | 051_p5_module.sql | documented
- sql | 052_domain_events_outbox.sql | documented
- sql | 053_rapor_kurmer.sql | documented
- sql | 054_finance_midtrans.sql | documented
- sql | 055_bos_expense_tracking.sql | documented
- sql | 056_ppdb_flow.sql | documented
- sql | 057_integrations.sql | documented
- sql | 058_ai_polish.sql | documented
- sql | 059_audit_rate_limit_perf.sql | documented
- sql | 060_counseling_parent_links_sikap.sql | documented
- sql | 061_app_audit_triggers.sql | documented
- sql | 062_rapor_autogen_rpc.sql | documented
- sql | 063_rombel_attendance.sql | documented
- sql | 064_stub_tables.sql | documented
- sql | 065_gradebook_baseline.sql | documented
- sql | 066_role_enum_completeness.sql | documented
- sql | 067_idempotent_auto_modules.sql | documented
- sql | 068_sync_user_roles_to_granular.sql | documented
- sql | 069_classes_rombel_id.sql | documented
- sql | 070_event_handler_idempotency.sql | documented
- sql | 071_ai_rate_limit.sql | documented
- sql | 072_parent_invoices_rpc.sql | documented
- sql | 073_refresh_tokens_session_metadata.sql | documented
- sql | 074_tenant_invites_and_settings.sql | documented
- sql | 075_tenant_invites_global_unique_code.sql | documented
- sql | 076_invalidate_refresh_tokens_post_rotation.sql | documented
- sql | 077_plagiarism_checks.sql | documented
- sql | 078_scorm_runtime_data.sql | documented
