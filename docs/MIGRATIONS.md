...
| 018_fix_backend_schema_bugs.sql | Undocumented migration |
| 019_audit_fixes.sql | Undocumented migration |
| 020_fix_rpc_signatures.sql | Undocumented migration |
| 021_rpc_json.sql | Undocumented migration |
| 022_align_table_columns.sql | Undocumented migration |
| 023_rpc_stubs.sql | Undocumented migration |
| 024_course_review_workflow.sql | Undocumented migration |
| 025_personal_and_multi_tenant.sql | Undocumented migration |
| 026_join_code_and_slugify.sql | Undocumented migration |
| 027_p2_backlog.sql | Undocumented migration |
| 028_p3_tenant_settings_and_roles.sql | Undocumented migration |
| 029_add_admin_notification_types.sql | Undocumented migration |
| 030_admin_stub_tables_and_rpcs.sql | Undocumented migration |
| 031_qa_schema_gaps.sql | Undocumented migration |
| 032_qa_rpcs.sql | Undocumented migration |
| 033_fix_search_questions_return_json.sql | Undocumented migration |
| 034_lesson_progress_monitor_rpc.sql | Undocumented migration |
| 035_admin_backfill.sql | Undocumented migration |
| 036_confirm_demo_seed_users.sql | Undocumented migration |
| 037_qa_sweep_fixes.sql | Undocumented migration |
| 037_seed_modules_missing_rpcs_and_auth_uid.sql | Undocumented migration |
| 038_fix_get_tenant_users_user_id_alias.sql | Undocumented migration |
| 039_academic_years.sql | Undocumented migration |
| 040_semesters_link_academic_year.sql | Undocumented migration |
| 041_grade_levels.sql | Undocumented migration |
| 042_rombel.sql | Undocumented migration |
| 043_subjects_and_curriculum_items.sql | Undocumented migration |
| 044_timetable_slots.sql | Undocumented migration |
| 045_dossiers.sql | Undocumented migration |
| 046_rbac_10_role_matrix.sql | Undocumented migration |
| 047_cp_tagging.sql | Undocumented migration |
| 048_gradebook_dual_mode.sql | Undocumented migration |
| 049_nilai_per_cp.sql | Undocumented migration |
| 050_akm_question_type.sql | Undocumented migration |
| 051_p5_module.sql | Undocumented migration |
| 052_domain_events_outbox.sql | Undocumented migration |
| 053_rapor_kurmer.sql | Undocumented migration |
| 054_finance_midtrans.sql | Undocumented migration |
| 055_bos_expense_tracking.sql | Undocumented migration |
| 056_ppdb_flow.sql | Undocumented migration |
| 057_integrations.sql | Undocumented migration |
| 058_ai_polish.sql | Undocumented migration |
| 059_audit_rate_limit_perf.sql | Undocumented migration |
| 060_counseling_parent_links_sikap.sql | Undocumented migration |
| 061_app_audit_triggers.sql | Undocumented migration |
| 062_rapor_autogen_rpc.sql | Undocumented migration |
| 063_rombel_attendance.sql | Undocumented migration |
| 064_stub_tables.sql | Undocumented migration |
| 065_gradebook_baseline.sql | Undocumented migration |
| 066_role_enum_completeness.sql | Undocumented migration |
| 067_idempotent_auto_modules.sql | Undocumented migration |
| 068_sync_user_roles_to_granular.sql | Undocumented migration |
| 069_classes_rombel_id.sql | Undocumented migration |
| 070_event_handler_idempotency.sql | Undocumented migration |
| 071_ai_rate_limit.sql | Undocumented migration |
| 072_parent_invoices_rpc.sql | Undocumented migration |
| 073_refresh_tokens_session_metadata.sql | Undocumented migration |
| 074_tenant_invites_and_settings.sql | Undocumented migration |
| 075_tenant_invites_global_unique_code.sql | Undocumented migration |
| 076_invalidate_refresh_tokens_post_rotation.sql | Undocumented migration |
| 077_plagiarism_checks.sql | Undocumented migration |
| 078_scorm_runtime_data.sql | Undocumented migration |
