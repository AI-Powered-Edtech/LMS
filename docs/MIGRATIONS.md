...
| 018_fix_backend_schema_bugs.sql | Schema | Deskripsi otomatis. |
| 019_audit_fixes.sql | Schema | Deskripsi otomatis. |
| 020_fix_rpc_signatures.sql | Schema | Deskripsi otomatis. |
| 021_rpc_json.sql | Schema | Deskripsi otomatis. |
| 022_align_table_columns.sql | Schema | Deskripsi otomatis. |
| 023_rpc_stubs.sql | Schema | Deskripsi otomatis. |
| 024_course_review_workflow.sql | Schema | Deskripsi otomatis. |
| 025_personal_and_multi_tenant.sql | Schema | Deskripsi otomatis. |
| 026_join_code_and_slugify.sql | Schema | Deskripsi otomatis. |
| 027_p2_backlog.sql | Schema | Deskripsi otomatis. |
| 028_p3_tenant_settings_and_roles.sql | Schema | Deskripsi otomatis. |
| 029_add_admin_notification_types.sql | Schema | Deskripsi otomatis. |
| 030_admin_stub_tables_and_rpcs.sql | Schema | Deskripsi otomatis. |
| 031_qa_schema_gaps.sql | Schema | Deskripsi otomatis. |
| 032_qa_rpcs.sql | Schema | Deskripsi otomatis. |
| 033_fix_search_questions_return_json.sql | Schema | Deskripsi otomatis. |
| 034_lesson_progress_monitor_rpc.sql | Schema | Deskripsi otomatis. |
| 035_admin_backfill.sql | Schema | Deskripsi otomatis. |
| 036_confirm_demo_seed_users.sql | Schema | Deskripsi otomatis. |
| 037_qa_sweep_fixes.sql | Schema | Deskripsi otomatis. |
| 037_seed_modules_missing_rpcs_and_auth_uid.sql | Schema | Deskripsi otomatis. |
| 038_fix_get_tenant_users_user_id_alias.sql | Schema | Deskripsi otomatis. |
| 039_academic_years.sql | Schema | Deskripsi otomatis. |
| 040_semesters_link_academic_year.sql | Schema | Deskripsi otomatis. |
| 041_grade_levels.sql | Schema | Deskripsi otomatis. |
| 042_rombel.sql | Schema | Deskripsi otomatis. |
| 043_subjects_and_curriculum_items.sql | Schema | Deskripsi otomatis. |
| 044_timetable_slots.sql | Schema | Deskripsi otomatis. |
| 045_dossiers.sql | Schema | Deskripsi otomatis. |
| 046_rbac_10_role_matrix.sql | Schema | Deskripsi otomatis. |
| 047_cp_tagging.sql | Schema | Deskripsi otomatis. |
| 048_gradebook_dual_mode.sql | Schema | Deskripsi otomatis. |
| 049_nilai_per_cp.sql | Schema | Deskripsi otomatis. |
| 050_akm_question_type.sql | Schema | Deskripsi otomatis. |
| 051_p5_module.sql | Schema | Deskripsi otomatis. |
| 052_domain_events_outbox.sql | Schema | Deskripsi otomatis. |
| 053_rapor_kurmer.sql | Schema | Deskripsi otomatis. |
| 054_finance_midtrans.sql | Schema | Deskripsi otomatis. |
| 055_bos_expense_tracking.sql | Schema | Deskripsi otomatis. |
| 056_ppdb_flow.sql | Schema | Deskripsi otomatis. |
| 057_integrations.sql | Schema | Deskripsi otomatis. |
| 058_ai_polish.sql | Schema | Deskripsi otomatis. |
| 059_audit_rate_limit_perf.sql | Schema | Deskripsi otomatis. |
| 060_counseling_parent_links_sikap.sql | Schema | Deskripsi otomatis. |
| 061_app_audit_triggers.sql | Schema | Deskripsi otomatis. |
| 062_rapor_autogen_rpc.sql | Schema | Deskripsi otomatis. |
| 063_rombel_attendance.sql | Schema | Deskripsi otomatis. |
| 064_stub_tables.sql | Schema | Deskripsi otomatis. |
| 065_gradebook_baseline.sql | Schema | Deskripsi otomatis. |
| 066_role_enum_completeness.sql | Schema | Deskripsi otomatis. |
| 067_idempotent_auto_modules.sql | Schema | Deskripsi otomatis. |
| 068_sync_user_roles_to_granular.sql | Schema | Deskripsi otomatis. |
| 069_classes_rombel_id.sql | Schema | Deskripsi otomatis. |
| 070_event_handler_idempotency.sql | Schema | Deskripsi otomatis. |
| 071_ai_rate_limit.sql | Schema | Deskripsi otomatis. |
| 072_parent_invoices_rpc.sql | Schema | Deskripsi otomatis. |
| 073_refresh_tokens_session_metadata.sql | Schema | Deskripsi otomatis. |
| 074_tenant_invites_and_settings.sql | Schema | Deskripsi otomatis. |
| 075_tenant_invites_global_unique_code.sql | Schema | Deskripsi otomatis. |
