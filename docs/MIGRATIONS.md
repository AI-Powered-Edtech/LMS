...
| 018_fix_backend_schema_bugs.sql | Schema | |

| 019_audit_fixes.sql | Schema | |

| 020_fix_rpc_signatures.sql | Schema | |

| 021_rpc_json.sql | Schema | |

| 022_align_table_columns.sql | Schema | |

| 023_rpc_stubs.sql | Schema | |

| 024_course_review_workflow.sql | Schema | |

| 025_personal_and_multi_tenant.sql | Schema | |

| 026_join_code_and_slugify.sql | Schema | |

| 027_p2_backlog.sql | Schema | |

| 028_p3_tenant_settings_and_roles.sql | Schema | |

| 029_add_admin_notification_types.sql | Schema | |

| 030_admin_stub_tables_and_rpcs.sql | Schema | |

| 031_qa_schema_gaps.sql | Schema | |

| 032_qa_rpcs.sql | Schema | |

| 033_fix_search_questions_return_json.sql | Schema | |

| 034_lesson_progress_monitor_rpc.sql | Schema | |

| 035_admin_backfill.sql | Schema | |

| 036_confirm_demo_seed_users.sql | Schema | |

| 037_qa_sweep_fixes.sql | Schema | |

| 037_seed_modules_missing_rpcs_and_auth_uid.sql | Schema | |

| 038_fix_get_tenant_users_user_id_alias.sql | Schema | |
...
| 046_rbac_10_role_matrix.sql | Schema | |

| 047_cp_tagging.sql | Schema | |

| 048_gradebook_dual_mode.sql | Schema | |

| 049_nilai_per_cp.sql | Schema | |

| 050_akm_question_type.sql | Schema | |

| 051_p5_module.sql | Schema | |

| 052_domain_events_outbox.sql | Schema | |

| 053_rapor_kurmer.sql | Schema | |

| 054_finance_midtrans.sql | Schema | |

| 055_bos_expense_tracking.sql | Schema | |

| 056_ppdb_flow.sql | Schema | |

| 057_integrations.sql | Schema | |

| 058_ai_polish.sql | Schema | |

| 059_audit_rate_limit_perf.sql | Schema | |

| 060_counseling_parent_links_sikap.sql | Schema | |

| 061_app_audit_triggers.sql | Schema | |

| 062_rapor_autogen_rpc.sql | Schema | |

| 063_rombel_attendance.sql | Schema | |

| 064_stub_tables.sql | Schema | |

| 065_gradebook_baseline.sql | Schema | |

| 066_role_enum_completeness.sql | Schema | |

| 067_idempotent_auto_modules.sql | Schema | |

| 068_sync_user_roles_to_granular.sql | Schema | |

| 069_classes_rombel_id.sql | Schema | |

| 070_event_handler_idempotency.sql | Schema | |

| 071_ai_rate_limit.sql | Schema | |

| 072_parent_invoices_rpc.sql | Schema | |

| 073_refresh_tokens_session_metadata.sql | Schema | |

| 074_tenant_invites_and_settings.sql | Schema | |

| 075_tenant_invites_global_unique_code.sql | Schema | |

| 076_invalidate_refresh_tokens_post_rotation.sql | Schema | |

| 077_plagiarism_checks.sql | Schema | |

| 078_scorm_runtime_data.sql | Schema | |
