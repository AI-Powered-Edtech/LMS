...
| 018_fix_backend_schema_bugs.sql | added | - |
| 019_audit_fixes.sql | added | - |
| 020_fix_rpc_signatures.sql | added | - |
| 021_rpc_json.sql | added | - |
| 022_align_table_columns.sql | added | - |
| 023_rpc_stubs.sql | added | - |
| 024_course_review_workflow.sql | added | - |
| 025_personal_and_multi_tenant.sql | added | - |
| 026_join_code_and_slugify.sql | added | - |
| 027_p2_backlog.sql | added | - |
| 028_p3_tenant_settings_and_roles.sql | added | - |
| 029_add_admin_notification_types.sql | added | - |
| 030_admin_stub_tables_and_rpcs.sql | added | - |
| 031_qa_schema_gaps.sql | added | - |
| 032_qa_rpcs.sql | added | - |
| 033_fix_search_questions_return_json.sql | added | - |
| 034_lesson_progress_monitor_rpc.sql | added | - |
| 035_admin_backfill.sql | added | - |
| 036_confirm_demo_seed_users.sql | added | - |
| 037_qa_sweep_fixes.sql | added | - |
| 037_seed_modules_missing_rpcs_and_auth_uid.sql | added | - |
| 038_fix_get_tenant_users_user_id_alias.sql | added | - |
| 039_academic_years.sql | added | - |
| 040_semesters_link_academic_year.sql | added | - |
| 041_grade_levels.sql | added | - |
| 042_rombel.sql | added | - |
| 043_subjects_and_curriculum_items.sql | added | - |
| 044_timetable_slots.sql | added | - |
| 045_dossiers.sql | added | - |
| 046_rbac_10_role_matrix.sql | added | - |
| 047_cp_tagging.sql | added | - |
| 048_gradebook_dual_mode.sql | added | - |
| 049_nilai_per_cp.sql | added | - |
| 050_akm_question_type.sql | added | - |
| 051_p5_module.sql | added | - |
| 052_domain_events_outbox.sql | added | - |
| 053_rapor_kurmer.sql | added | - |
| 054_finance_midtrans.sql | added | - |
| 055_bos_expense_tracking.sql | added | - |
| 056_ppdb_flow.sql | added | - |
| 057_integrations.sql | added | - |
| 058_ai_polish.sql | added | - |
| 059_audit_rate_limit_perf.sql | added | - |
| 060_counseling_parent_links_sikap.sql | added | - |
| 061_app_audit_triggers.sql | added | - |
| 062_rapor_autogen_rpc.sql | added | - |
| 063_rombel_attendance.sql | added | - |
| 064_stub_tables.sql | added | - |
| 065_gradebook_baseline.sql | added | - |
| 066_role_enum_completeness.sql | added | - |
| 067_idempotent_auto_modules.sql | added | - |
| 068_sync_user_roles_to_granular.sql | added | - |
| 069_classes_rombel_id.sql | added | - |
| 070_event_handler_idempotency.sql | added | - |
| 071_ai_rate_limit.sql | added | - |
| 072_parent_invoices_rpc.sql | added | - |
| 073_refresh_tokens_session_metadata.sql | added | - |
| 074_tenant_invites_and_settings.sql | added | - |
| 075_tenant_invites_global_unique_code.sql | added | - |
| 076_invalidate_refresh_tokens_post_rotation.sql | added | - |
| 077_plagiarism_checks.sql | added | - |
| 078_scorm_runtime_data.sql | added | - |
