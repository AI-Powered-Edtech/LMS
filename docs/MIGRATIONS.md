...
- sql | 018_fix_backend_schema_bugs.sql | Documented auto
- sql | 019_audit_fixes.sql | Documented auto
- sql | 020_fix_rpc_signatures.sql | Documented auto
- sql | 021_rpc_json.sql | Documented auto
- sql | 022_align_table_columns.sql | Documented auto
- sql | 023_rpc_stubs.sql | Documented auto
- sql | 024_course_review_workflow.sql | Documented auto
- sql | 025_personal_and_multi_tenant.sql | Documented auto
- sql | 026_join_code_and_slugify.sql | Documented auto
- sql | 027_p2_backlog.sql | Documented auto
- sql | 028_p3_tenant_settings_and_roles.sql | Documented auto
- sql | 029_add_admin_notification_types.sql | Documented auto
- sql | 030_admin_stub_tables_and_rpcs.sql | Documented auto
- sql | 031_qa_schema_gaps.sql | Documented auto
- sql | 032_qa_rpcs.sql | Documented auto
- sql | 033_fix_search_questions_return_json.sql | Documented auto
- sql | 034_lesson_progress_monitor_rpc.sql | Documented auto
- sql | 035_admin_backfill.sql | Documented auto
- sql | 036_confirm_demo_seed_users.sql | Documented auto
- sql | 037_qa_sweep_fixes.sql | Documented auto
- sql | 037_seed_modules_missing_rpcs_and_auth_uid.sql | Documented auto
- sql | 038_fix_get_tenant_users_user_id_alias.sql | Documented auto
- sql | 039_academic_years.sql | Documented auto
- sql | 040_semesters_link_academic_year.sql | Documented auto
- sql | 041_grade_levels.sql | Documented auto
- sql | 042_rombel.sql | Documented auto
- sql | 043_subjects_and_curriculum_items.sql | Documented auto
- sql | 044_timetable_slots.sql | Documented auto
- sql | 045_dossiers.sql | Documented auto
- sql | 046_rbac_10_role_matrix.sql | Documented auto
- sql | 047_cp_tagging.sql | Documented auto
- sql | 048_gradebook_dual_mode.sql | Documented auto
- sql | 049_nilai_per_cp.sql | Documented auto
- sql | 050_akm_question_type.sql | Documented auto
- sql | 051_p5_module.sql | Documented auto
- sql | 052_domain_events_outbox.sql | Documented auto
- sql | 053_rapor_kurmer.sql | Documented auto
- sql | 054_finance_midtrans.sql | Documented auto
- sql | 055_bos_expense_tracking.sql | Documented auto
- sql | 056_ppdb_flow.sql | Documented auto
- sql | 057_integrations.sql | Documented auto
- sql | 058_ai_polish.sql | Documented auto
- sql | 059_audit_rate_limit_perf.sql | Documented auto
- sql | 060_counseling_parent_links_sikap.sql | Documented auto
- sql | 061_app_audit_triggers.sql | Documented auto
- sql | 062_rapor_autogen_rpc.sql | Documented auto
- sql | 063_rombel_attendance.sql | Documented auto
- sql | 064_stub_tables.sql | Documented auto
- sql | 065_gradebook_baseline.sql | Documented auto
- sql | 066_role_enum_completeness.sql | Documented auto
- sql | 067_idempotent_auto_modules.sql | Documented auto
- sql | 068_sync_user_roles_to_granular.sql | Documented auto
- sql | 069_classes_rombel_id.sql | Documented auto
- sql | 070_event_handler_idempotency.sql | Documented auto
- sql | 071_ai_rate_limit.sql | Documented auto
- sql | 072_parent_invoices_rpc.sql | Documented auto
- sql | 073_refresh_tokens_session_metadata.sql | Documented auto
- sql | 074_tenant_invites_and_settings.sql | Documented auto
- sql | 075_tenant_invites_global_unique_code.sql | Documented auto
- sql | 076_invalidate_refresh_tokens_post_rotation.sql | Documented auto
- sql | 077_plagiarism_checks.sql | Documented auto
- sql | 078_scorm_runtime_data.sql | Documented auto
