...
| 001_create_users_table.sql | Backlog | |
| 002_auth_replacement_functions.sql | Backlog | |
| 003_invitations_and_memberships.sql | Backlog | |
| 004_create_ai_tutor_sessions.sql | Backlog | |
| 005_create_lti_tables.sql | Backlog | |
| 006_add_realtime_triggers.sql | Backlog | |
| 007_add_storage_tracking.sql | Backlog | |
| 008_tighten_rls_for_vil.sql | Backlog | |
| 009_drop_rls.sql | Backlog | |
| 012_video_transcoding_jobs.sql | Backlog | |
| 013_export_jobs.sql | Backlog | |
| 014_gradebook_realtime_triggers.sql | Backlog | |
| 015_backend_heavy_tables.sql | Backlog | |
| 016_add_performance_indexes.sql | Backlog | |
| 017_add_google_id_to_profiles.sql | Backlog | |
| 018_fix_backend_schema_bugs.sql | Backlog | |
| 019_audit_fixes.sql | Backlog | |
| 020_fix_rpc_signatures.sql | Backlog | |
| 021_rpc_json.sql | Backlog | |
| 022_align_table_columns.sql | Backlog | |
| 023_rpc_stubs.sql | Backlog | |
| 024_course_review_workflow.sql | Backlog | |
| 025_personal_and_multi_tenant.sql | Backlog | |
| 026_join_code_and_slugify.sql | Backlog | |
| 027_p2_backlog.sql | Backlog | |
| 028_p3_tenant_settings_and_roles.sql | Backlog | |
| 029_add_admin_notification_types.sql | Backlog | |
| 030_admin_stub_tables_and_rpcs.sql | Backlog | |
| 031_qa_schema_gaps.sql | Backlog | |
| 032_qa_rpcs.sql | Backlog | |
| 033_fix_search_questions_return_json.sql | Backlog | |
| 034_lesson_progress_monitor_rpc.sql | Backlog | |
| 035_admin_backfill.sql | Backlog | |
| 036_confirm_demo_seed_users.sql | Backlog | |
| 037_qa_sweep_fixes.sql | Backlog | |
| 037_seed_modules_missing_rpcs_and_auth_uid.sql | Backlog | |
| 038_fix_get_tenant_users_user_id_alias.sql | Backlog | |
| 039_academic_years.sql | Backlog | |
| 040_semesters_link_academic_year.sql | Backlog | |
| 041_grade_levels.sql | Backlog | |
| 042_rombel.sql | Backlog | |
| 043_subjects_and_curriculum_items.sql | Backlog | |
| 044_timetable_slots.sql | Backlog | |
| 045_dossiers.sql | Backlog | |
| 046_rbac_10_role_matrix.sql | Backlog | |
| 047_cp_tagging.sql | Backlog | |
| 048_gradebook_dual_mode.sql | Backlog | |
| 049_nilai_per_cp.sql | Backlog | |
| 050_akm_question_type.sql | Backlog | |
| 051_p5_module.sql | Backlog | |
| 052_domain_events_outbox.sql | Backlog | |
| 053_rapor_kurmer.sql | Backlog | |
| 054_finance_midtrans.sql | Backlog | |
| 055_bos_expense_tracking.sql | Backlog | |
| 056_ppdb_flow.sql | Backlog | |
| 057_integrations.sql | Backlog | |
| 058_ai_polish.sql | Backlog | |
| 059_audit_rate_limit_perf.sql | Backlog | |
| 060_counseling_parent_links_sikap.sql | Backlog | |
| 061_app_audit_triggers.sql | Backlog | |
| 062_rapor_autogen_rpc.sql | Backlog | |
| 063_rombel_attendance.sql | Backlog | |
| 064_stub_tables.sql | Backlog | |
| 065_gradebook_baseline.sql | Backlog | |
| 066_role_enum_completeness.sql | Backlog | |
| 067_idempotent_auto_modules.sql | Backlog | |
| 068_sync_user_roles_to_granular.sql | Backlog | |
| 069_classes_rombel_id.sql | Backlog | |
| 070_event_handler_idempotency.sql | Backlog | |
| 071_ai_rate_limit.sql | Backlog | |
| 072_parent_invoices_rpc.sql | Backlog | |
| 073_refresh_tokens_session_metadata.sql | Backlog | |
| 074_tenant_invites_and_settings.sql | Backlog | |
| 075_tenant_invites_global_unique_code.sql | Backlog | |
