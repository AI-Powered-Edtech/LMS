...
Konten pelajaran dengan block-based editor. Mendukung teks, video, kuis inline, dan interaktif lainnya.
...
Tabel yang digunakan oleh lessons dilindungi oleh RLS policy:
...
- `lessons` — Tabel lessons untuk Pelajaran
- `lesson_blocks` — Tabel lesson blocks untuk Pelajaran
- `student_lesson_signals` — Tabel student lesson signals untuk Pelajaran

## RPC / Edge Functions

Fungsi-fungsi database yang terkait dengan lessons:

- `get_lessons_stats()` — Statistik aggregat
- `search_lessons()` — Full-text search

## UI Pages

| Route                    | Deskripsi                     | Role    |
| ------------------------ | ----------------------------- | ------- |
| `/#/app/student/lessons` | Halaman Pelajaran untuk siswa | Student |
| `/#/app/teacher/lessons` | Halaman Pelajaran untuk guru  | Teacher |
| `/#/app/admin/lessons`   | Halaman Pelajaran untuk admin | Admin   |

## Komponen

- **LessonsSkeleton** — Loading skeleton
- **LessonsCard** — Kartu item
- **LessonsTable** — Tabel data
- **LessonsStats** — Kartu statistik
- **LessonsFilterBar** — Bar pencarian dan filter

## Dependencies

Feature yang di-depend oleh lessons:
...
Feature yang depend ke lessons:
