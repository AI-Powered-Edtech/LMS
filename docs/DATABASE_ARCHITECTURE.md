...
| accessibility      | UI/UX          | Aksesibilitas — Kepatuhan dan pengujian aksesibilitas (WCAG)                                                               |
| adaptive-paths     | Learning       | Jalur Adaptif — Engine jalur pembelajaran adaptif                                                                          |
| ai-authoring       | Content        | Authoring AI — Pembuatan konten pelajaran berbantuan AI                                                                    |
| ai-quiz-gen        | Assessment     | Generator Kuis AI — Pembuatan kuis otomatis dari materi                                                                    |
| ai-recommendations | Learning       | Rekomendasi AI — Rekomendasi belajar personal berbasis AI                                                                  |
...
| attendance         | Academic       | Kehadiran — Pencatatan dan tracking kehadiran siswa                                                                        |
| auth               | Identity       | Autentikasi — Flow login, register, dan manajemen sesi                                                                     |
...
| certificates       | Learning       | Sertifikat — Pembuatan dan manajemen sertifikat otomatis                                                                   |
| classroom          | Academic       | Kelas — Manajemen kelas virtual dan fisik                                                                                  |
| course-builder     | Content        | Builder Kursus — Antarmuka drag-and-drop untuk membangun kursus                                                            |
| courses            | Academic       | Kursus — Core learning module                                                                                              |
| creator            | Content        | Kreator AI — Generator konten edukasi                                                                                      |
...
| interactive-blocks | Content        | Block Interaktif — Konten pelajaran interaktif                                                                             |
| lessons            | Learning       | Pelajaran — Konten pelajaran dengan block-based editor                                                                     |
| lti                | Integration    | LTI — Integrasi standar LTI 1.3                                                                                            |
...
| parent             | Parent         | Orang Tua — Portal khusus orang tua siswa                                                                                  |
| peer-review        | Assessment     | Peer Review — Sistem penilaian antar teman                                                                                 |
| plagiarism         | Assessment     | Plagiarisme — Deteksi kemiripan konten                                                                                     |
| principal          | Principal      | Kepala Sekolah — Dashboard eksekutif untuk kepala sekolah                                                                  |
| profile            | Identity       | Profil — Manajemen profil pengguna                                                                                         |
...
| quests             | Engagement     | Quest — Misi dan tantangan belajar gamified                                                                                |
...
| rubrics            | Assessment     | Rubrik — Builder rubrik penilaian untuk tugas dan kuis                                                                     |
| search             | Infrastructure | Pencarian — Engine pencarian global aplikasi                                                                               |
| semester           | Academic       | Semester — Manajemen periode akademik dan semester                                                                         |
| settings           | Identity       | Pengaturan — Konfigurasi preferensi pengguna                                                                               |
| storage            | Infrastructure | Penyimpanan — Manajemen file dan media untuk materi pembelajaran                                                           |
| struggle           | Analytics      | Deteksi Kesulitan — Deteksi otomatis siswa yang kesulitan berdasarkan pola belajar, waktu per soal, dan penurunan performa |
| surveys            | Analytics      | Survei — Survei sekolah dan feedback                                                                                       |
| video              | Content        | Video — Integrasi hosting dan player video                                                                                 |
| xapi               | Learning       | xAPI — Tracking standar Experience API                                                                                     |
