...
| Edge Functions     | 15 deployed (ai-tutor, ai-grade-essay, generate-ai-content, generate-pdf, grade-quiz-attempt, health-check, load-quiz-data, lti-jwks, lti-launch, lti-oidc-login, process-progress-events, progress-events, scorm-extract, send-email-digest, send-push) |
