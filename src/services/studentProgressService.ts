...
export const studentProgressService = {
     ...
     */
    async fetchLessonProgress(userId: string, tenantId: string): Promise<Record<string, LessonProgress>> {
        const { data } = await supabase
     ...
     */
    async updateLessonProgress(userId: string, lessonId: string, completed: boolean, tenantId: string): Promise<void> {
