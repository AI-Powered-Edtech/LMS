...
describe("translateAuthError", () => {
  ...
  it("should return invalid credentials message for login errors", () => {
    ...
    expect(translateAuthError("invalid_credentials provided")).toBe("Email atau kata sandi salah. Silakan coba lagi.");
  });
  ...
  it("should return user not found message", () => {
    expect(translateAuthError("User not found in the system")).toBe("Akun tidak ditemukan. Pastikan email yang dimasukkan benar.");
  });
