...
describe("translateAuthError", () => {
  ...
  it("translates network errors", () => {
    ...
    expect(
      translateAuthError("Mixed Content: The page at was loaded over HTTPS"),
    ).toBe(expected);
  });
  ...
  it("translates weak password length", () => {
  ...
  it("translates weak password strength", () => {
    const expected =
  ...
  it("returns raw message if unknown", () => {
    const message = "Some random unknown error";
