...
describe("translateAuthError", () => {
  ...
  it("translates network errors", () => {
    ...
    expect(translateAuthError("NetworkError: failed to connect")).toBe(expected);
  ...
  it("returns raw message if unknown error", () => {
    const unknownError = "Some random super weird error we have never seen";
