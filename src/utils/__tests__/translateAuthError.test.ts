...
describe("translateAuthError", () => {
  it("should return fallback message for empty input", () => {
  ...
  it("should translate password length issues", () => {
  ...
  it("should translate weak password issues", () => {
    const expected =
  ...
  it("should translate token expiration", () => {
  ...
  it("should return the raw message as fallback if unknown", () => {
    const unknownMsg = "Some completely unknown error code 500";
    expect(translateAuthError(unknownMsg)).toBe(unknownMsg);
  });
});
