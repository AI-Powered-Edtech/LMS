...
describe("translateAuthError", () => {
  it("handles missing or empty message", () => {
  ...
  it("translates weak password", () => {
    ...
    expect(translateAuthError("Password strength is too weak")).toBe("Kata sandi terlalu lemah. Gunakan kombinasi huruf dan angka.");
  });
  ...
  it("returns the raw message if it does not match any known errors", () => {
    expect(translateAuthError("Some obscure error")).toBe("Some obscure error");
  });
});
