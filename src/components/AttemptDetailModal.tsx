                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <input
                              ...
                              placeholder="0"
                              className="w-20 px-3 py-1.5 normal-case tracking-normal bg-slate-50 border border-slate-200 rounded-lg text-sm text-center focus:ring-2 focus:ring-blue-500 outline-none"
                            />
                      ...
                      <div>
                        ...
                        >
                          ...
                          <textarea
                            ...
                            rows={2}
                            className="mt-1.5 w-full px-3 py-2 normal-case tracking-normal bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none resize-none"
                          />
                        </label>
                      </div>
