                    ...
                    <div className="mt-3 p-4 bg-white border border-slate-200 rounded-xl space-y-3">
                      ...
                      <div className="flex items-center gap-3">
                        <label
                          ...
                          className="flex items-center gap-3 text-xs font-medium text-slate-500 uppercase tracking-wide"
                        >
                          <span className="shrink-0">Nilai</span>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <textarea
                            ...
                            rows={2}
                            className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none resize-none font-normal normal-case"
                          />
                        </label>
                      </div>
