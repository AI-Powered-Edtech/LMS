                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            placeholder="0"
                            className="w-20 px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-sm normal-case tracking-normal text-center focus:ring-2 focus:ring-blue-500 outline-none text-slate-800"
                          />
