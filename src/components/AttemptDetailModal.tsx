                      ...
                      <div>
                        ...
                        >
                          ...
                          <textarea
                            ...
                            rows={2}
                            className="mt-1.5 normal-case tracking-normal w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 outline-none resize-none"
                          />
                        </label>
                      </div>
