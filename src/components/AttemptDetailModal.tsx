...
export function AttemptDetailModal({
    ...
    const [gradingToast, setGradingToast] = useState<Record<string, { type: 'success' | 'error'; message: string }>>({});
                        ...
                        answers.map((answer, idx) => (
                            ...
                            >
                                ...
                                <div className="space-y-1.5 text-sm">
                                    ...
                                    {!answer.is_correct && answer.correct_option_text && !isEssayType(answer.question_type) && (
