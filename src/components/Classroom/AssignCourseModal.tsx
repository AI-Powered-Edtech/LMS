...
export function AssignCourseModal({ isOpen, onClose, courseId, courseTitle }: AssignCourseModalProps) {
                        ...
                        <div className="p-8 max-h-[60vh] overflow-y-auto custom-scrollbar">
                            {loading ? (
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <p className="text-slate-500 text-sm mt-1">Buat kelas terlebih dahulu untuk menugaskan materi ini.</p>
                                </div>
                            ) : (
                                                ...
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <p className={cn(
                                                            ...
                                                            isAssigned ? "text-indigo-900 dark:text-indigo-200" : "text-slate-900 dark:text-white"
                                                        )}>
                                                            {cls.name}
                                                        </p>
