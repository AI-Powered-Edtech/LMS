...
export const Success: Story = {
  render: () => <ToastTrigger type="success" message="Data berhasil disimpan" />,
}
  ...
  return (
    <div className="p-8 flex flex-col gap-3">
      <button
        ...
        onClick={() => addToast({ type: 'success', message: 'Berhasil disimpan!' })}
      >
        Tampilkan Sukses
      </button>
      <button
        ...
        onClick={() =>
          addToast({ type: 'error', message: 'Terjadi kesalahan', description: 'Coba lagi.' })
        }
      >
        Tampilkan Error
      </button>
      ...
      <button
        ...
        onClick={() => addToast({ type: 'info', message: 'Info baru tersedia' })}
      >
        Tampilkan Info
      </button>
      <ToastContainer />
