...
function TabsWithIconsDemo() {
  ...
  return (
    <Tabs
      ...
      onChange={setActive}
      tabs={[
        { id: 'lessons', label: 'Materi', icon: <BookOpen className="w-4 h-4" /> },
        { id: 'assignments', label: 'Tugas', icon: <FileText className="w-4 h-4" /> },
...
function TabsWithCountsDemo() {
  ...
  return (
    <Tabs
      ...
      onChange={setActive}
      tabs={[
        { id: 'students', label: 'Siswa', count: 32, icon: <Users className="w-4 h-4" /> },
        { id: 'assignments', label: 'Tugas', count: 5, icon: <FileText className="w-4 h-4" /> },
        { id: 'analytics', label: 'Analitik', icon: <BarChart3 className="w-4 h-4" /> },
      ]}
    />
  )
