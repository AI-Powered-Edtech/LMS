...
import { UserCircle, Plus, ChevronDown, Check, LogOut } from "lucide-react";
        ...
        <div className="mb-6 px-2 relative">
          ...
          >
            <div className="flex flex-col items-start truncate pr-2">
              <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Kelas Aktif</span>
              <span className="text-sm font-bold text-slate-900 dark:text-white truncate w-full text-left">{activeClassroom?.name || 'Pilih kelas'}</span>
            </div>
