      ...
      <div className="flex items-center gap-4 sm:gap-6">
        ...
        {isStudent ? (
          <>
            ...
            <Tooltip
              content="Streak belajar (hari berturut-turut)"
              position="bottom"
            >
              <div
            ...
            <div className="flex items-center gap-3">
              ...
              <Tooltip content="Total Experience Points" position="bottom">
                <div
                  className="flex items-center gap-1.5 bg-gradient-to-r from-yellow-100 to-orange-100 dark:from-yellow-900/30 dark:to-orange-900/30 text-yellow-700 dark:text-yellow-500 px-2.5 py-1 rounded-lg font-bold text-sm border border-yellow-200/50 dark:border-yellow-700/30 cursor-help"
                  role="status"
