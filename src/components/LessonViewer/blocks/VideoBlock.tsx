...
export function VideoBlock({
  ...
  useEffect(() => {
    if (
      ...
      savedVideoPosition > maxWatchedTimeRef.current
    ) {
              ...
              visibilityCheckInterval = setInterval(() => {
                ...
                if (document.visibilityState === "visible") {
                  ...
                  const intermediatePct = Math.min(
                    Math.round(
                      (visibleSeconds / REQUIRED_VISIBLE_SECONDS) * 79,
                    ),
                    79,
                  );
                ...
                if (
                  visibleSeconds >= REQUIRED_VISIBLE_SECONDS &&
                  !hasCalledCompletion.current
                ) {
                  hasCalledCompletion.current = true;
                  onProgressUpdate(80);
      ...
      <div className="px-6 py-4">
        ...
        >
          <iframe
            ...
            title={
              blockId ? `Pemutar video ${blockId.slice(-6)}` : "Pemutar video"
            }
          />
        </div>
      </div>
      ...
      <div className="px-6 py-4">
        ...
        >
          <AdaptiveVideoPlayer
            ...
            aria-label={
              blockId ? `Pemutar video ${blockId.slice(-6)}` : "Video pelajaran"
            }
