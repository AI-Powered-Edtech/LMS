...
export function AssignmentViewer({
    ...
    const handleSubmit = async () => {
        ...
        setError(null);
        try {
            const submissionData: Omit<AssignmentSubmission, 'id' | 'submitted_at' | 'graded_at' | 'score' | 'feedback' | 'status'> = {
        ...
        <div className="flex-1 overflow-auto bg-slate-50/30">
            <div className="max-w-4xl mx-auto p-6 md:p-10 space-y-8">
                ...
                <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
                    <div className="p-8 space-y-6">
                                ...
                                <div className="flex items-center gap-4 mt-2">
                                    ...
                                    {dueDate && (
                                        <div className="flex items-center gap-1.5 text-xs font-bold text-rose-500 uppercase tracking-wider">
                                            ...
                                            Tenggat: {new Date(dueDate).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        <div className="prose prose-slate max-w-none">
                            <h4 className="text-sm font-bold text-slate-900 uppercase tracking-widest mb-3">Instruksi</h4>
                ...
                <div className="space-y-4">
                    <h4 className="text-sm font-bold text-slate-900 uppercase tracking-widest px-1">Pekerjaan Anda</h4>
                        ...
                        {!isGraded && (
                            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                                <p className="text-xs text-slate-400 font-medium">
                                    {isSubmitted ? 'Anda dapat membatalkan pengiriman untuk mengedit.' : 'Pastikan jawaban Anda sudah lengkap sebelum mengirim.'}
                                </p>
