        ...
        <div>
          ...
          >
            ...
            <input
              ...
              className="w-full px-5 py-3 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all font-bold text-slate-700 placeholder:text-slate-400 shadow-sm normal-case tracking-normal mt-2"
        ...
        <div>
          ...
          >
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-5 py-3 bg-white border border-slate-200 rounded-[24px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all resize-none font-medium text-slate-600 placeholder:text-slate-400 shadow-sm leading-relaxed normal-case tracking-normal mt-2"
          ...
          <div>
            ...
            >
              ...
              <input
                ...
                className="w-full px-5 py-3 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all font-black text-slate-700 shadow-sm normal-case tracking-normal mt-2"
          ...
          >
            ...
            <div className="relative group mt-2">
              <input
                ...
                className="w-full pl-12 pr-5 py-3 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all font-bold text-slate-600 shadow-sm normal-case tracking-normal"
              />
