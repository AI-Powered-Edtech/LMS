        ...
        <div className="w-full space-y-6">
            ...
            <div className="flex items-start justify-between gap-4 p-6 bg-white rounded-[24px] border border-slate-100 shadow-sm">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className={cn(
                            ...
                            assignmentData.is_published ? 'bg-indigo-500 text-white shadow-indigo-100' : 'bg-slate-200 text-slate-500'
                        )}>
                            {assignmentData.is_published ? <CheckCircle className="w-3.5 h-3.5" /> : <AlertTriangle className="w-3.5 h-3.5" />}
                ...
                <div className="flex items-center gap-3 shrink-0">
                    ...
                    >
                        {isSaving ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <CheckCircle className="w-3.5 h-3.5 group-hover:scale-110 transition-transform" />}
                        SIMPAN PERUBAHAN
                    </button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 p-8 bg-slate-50/50 rounded-[32px] border border-slate-200/50">
                <div>
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2 px-1">Judul Tugas</label>
                    <input
                        type="text"
                ...
                <div>
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2 px-1">Instruksi Tugas</label>
                    <textarea
                ...
                <div className="grid grid-cols-2 gap-6">
                    <div>
                        <label className="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2 px-1">Maks. Poin</label>
                        <input
                            type="number"
                            min="1"
                ...
                <div>
                    <label className="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2 px-1">Tenggat Waktu (Opsional)</label>
