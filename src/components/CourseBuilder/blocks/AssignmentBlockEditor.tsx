        ...
        <div>
          ...
          >
            ...
            <input
              ...
              className="w-full px-5 py-3 mt-2 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all font-bold text-slate-700 placeholder:text-slate-400 shadow-sm normal-case tracking-normal"
        ...
        <div>
          ...
          >
            ...
            <textarea
              ...
              rows={6}
              className="w-full mt-2 px-5 py-3 bg-white border border-slate-200 rounded-[24px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all resize-none font-medium text-slate-600 placeholder:text-slate-400 shadow-sm leading-relaxed normal-case tracking-normal"
          ...
          <div>
            ...
            >
              ...
              <input
                ...
                className="w-full mt-2 px-5 py-3 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all font-black text-slate-700 shadow-sm normal-case tracking-normal"
          ...
          >
            ...
            <div className="relative group mt-2">
              <input
                ...
                className="w-full px-5 py-3 pl-12 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all font-bold text-slate-700 shadow-sm normal-case tracking-normal"
                aria-label="Tenggat Waktu"
              />
              <Calendar className="w-5 h-5 text-slate-400 absolute left-4 top-1/2 -translate-y-1/2 group-focus-within:text-indigo-500 transition-colors" />
            </div>
          </label>
        </div>
      </div>
