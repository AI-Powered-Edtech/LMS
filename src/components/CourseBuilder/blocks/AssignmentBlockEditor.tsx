        ...
        <div>
          ...
          >
            ...
            <input
              ...
              className="w-full mt-2 px-5 py-3 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all font-bold text-slate-700 placeholder:text-slate-400 shadow-sm"
        ...
        <div>
          ...
          >
            ...
            <textarea
              ...
              rows={4}
              className="w-full mt-2 px-5 py-3 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all resize-none text-slate-700 placeholder:text-slate-400 shadow-sm"
          ...
          <div>
            ...
            >
              ...
              <input
                ...
                className="w-full mt-2 px-5 py-3 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all font-black text-slate-700 shadow-sm"
              />
            </label>
          </div>
          <div>
