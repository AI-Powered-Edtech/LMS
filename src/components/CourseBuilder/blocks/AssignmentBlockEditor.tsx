        ...
        <div>
          ...
          >
            ...
            <input
              ...
              className="w-full px-5 py-3 mt-2 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all normal-case tracking-normal font-bold text-slate-700 placeholder:text-slate-400 shadow-sm"
        ...
        <div>
          ...
          >
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-5 py-3 mt-2 bg-white border border-slate-200 rounded-[24px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all resize-none normal-case tracking-normal font-medium text-slate-600 placeholder:text-slate-400 shadow-sm leading-relaxed"
          ...
          <div>
            ...
            >
              ...
              <input
                ...
                className="w-full px-5 py-3 mt-2 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all normal-case tracking-normal font-black text-slate-700 shadow-sm"
              />
            </label>
          </div>
          <div>
          ...
          >
            ...
            <div className="relative group mt-2">
              <input
                ...
                className="w-full px-5 py-3 pl-11 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all normal-case tracking-normal font-bold text-slate-700 shadow-sm"
              />
