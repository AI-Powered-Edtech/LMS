      ...
      <div className="grid grid-cols-1 gap-6 p-8 bg-slate-50/50 rounded-[32px] border border-slate-200/50">
        <div>
          ...
          >
            ...
            <input
              ...
              className="w-full px-5 py-3 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all font-bold text-slate-700 placeholder:text-slate-400 shadow-sm mt-1"
        ...
        <div>
          ...
          >
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-5 py-3 bg-white border border-slate-200 rounded-[24px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all resize-none font-medium text-slate-600 placeholder:text-slate-400 shadow-sm leading-relaxed mt-1"
          ...
          <div>
            ...
            >
              ...
              <input
                ...
                className="w-full px-5 py-3 bg-white border border-slate-200 rounded-[18px] focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all font-black text-slate-700 shadow-sm mt-1"
              />
            </label>
          </div>
          <div>
        ...
        <div>
          ...
          >
            ...
            <div className="relative group mt-1 font-normal">
              <input
