          ...
          <div>
            ...
            >
              ...
              <input
                ...
                type="number"
              className="mt-2 block w-full px-5 py-3 bg-white border border-slate-200 rounded-2xl focus:ring-4 focus:ring-indigo-50 focus:border-indigo-300 outline-none transition-all font-bold text-slate-700 normal-case tracking-normal shadow-sm"
              min="1"
