...
export function LessonBlockEditor() {
    ...
    const getBlockIcon = (type: string) => {
        switch (type?.toUpperCase()) {
            ...
            case 'FILE': return <File className="w-4 h-4 text-orange-500" />;
    ...
    const blockTypes = [
        { type: 'text', label: 'Teks', icon: <Type className="w-5 h-5" />, color: 'text-slate-700 bg-white hover:bg-slate-50 border-slate-200' },
        { type: 'video', label: 'Video', icon: <Video className="w-5 h-5" />, color: 'text-blue-600 bg-blue-50/30 hover:bg-blue-50 border-blue-100' },
        { type: 'image', label: 'Gambar', icon: <Image className="w-5 h-5" />, color: 'text-emerald-600 bg-emerald-50/30 hover:bg-emerald-50 border-emerald-100' },
        { type: 'file', label: 'File', icon: <File className="w-5 h-5" />, color: 'text-orange-600 bg-orange-50/30 hover:bg-orange-50 border-orange-100' },
        { type: 'quiz', label: 'Kuis', icon: <HelpCircle className="w-5 h-5" />, color: 'text-rose-600 bg-rose-50/30 hover:bg-rose-50 border-rose-100' },
        { type: 'assignment', label: 'Tugas', icon: <FileText className="w-5 h-5" />, color: 'text-indigo-600 bg-indigo-50/30 hover:bg-indigo-50 border-indigo-100' },
    ];
                ...
                <div className="mb-10 p-8 bg-white rounded-[32px] border border-slate-200/60 shadow-sm">
                    ...
                    <div className="flex items-center gap-3 mt-4">
                        ...
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                            {state.activeLesson.blocks.length} {state.activeLesson.blocks.length === 1 ? 'KONTEN' : 'KONTEN'}
                        </span>
                    </div>
                </div>
                                            ...
                                            {(dragProvided, snapshot) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-3 px-5 py-4 border-b border-slate-50">
                                                        <div {...dragProvided.dragHandleProps} className="p-1 text-slate-300 hover:text-slate-500 cursor-grab hover:bg-slate-50 rounded-lg transition-colors">
