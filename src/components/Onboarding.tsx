  ...
  const studentSteps = [
    {
      ...
      description:
        "Platform pembelajaran cerdas yang menyesuaikan dengan gaya belajarmu.",
      icon: Sparkles,
      color: "text-blue-500",
      bg: "bg-blue-100",
    },
  ...
  const teacherSteps = [
    {
      ...
      description:
        "Kelola kelas dan pantau perkembangan siswa dengan bantuan AI.",
      icon: Sparkles,
      color: "text-blue-500",
      bg: "bg-blue-100",
    },
    {
      title: "Kreator AI",
      description:
        "Buat materi, kuis, dan RPP secara otomatis dengan bantuan Kreator AI kami.",
      icon: Target,
    ...
    },
    {
      ...
      description:
        "Lihat analitik kelas, nilai tugas dengan cepat, dan berinteraksi di forum.",
      icon: Users,
  ...
  return (
    ...
    >
      <div
        ...
        onKeyDown={(e) => e.key === "Escape" && handleComplete()}
      />
      <div
        role="dialog"
        aria-modal="true"
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          exit={{ opacity: 0, x: -20 }}
          className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl w-full overflow-hidden relative"
        >
          {/* Close button */}
          <button
            type="button"
