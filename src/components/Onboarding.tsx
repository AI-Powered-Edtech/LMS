...
export function Onboarding() {
  ...
  const studentSteps = [
    ...
    },
    {
      ...
      description: "Ikuti jalur pembelajaran yang dirancang khusus untukmu. Selesaikan materi untuk membuka level berikutnya.",
      icon: Target,
    ...
    },
    {
      ...
      description: "Dapatkan XP dari setiap kuis dan tugas. Jadilah yang terbaik di Leaderboard kelasmu!",
      icon: Trophy,
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="p-8 text-center">
            <div className={`w-20 h-20 mx-auto rounded-full flex items-center justify-center mb-6 ${currentStep.bg}`}>
