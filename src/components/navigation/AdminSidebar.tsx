...
const INITIALLY_COLLAPSED = new Set<string>([
  ...
  "navigation.adminGroups.system.title",
  "navigation.adminGroups.finance.title",
]);
...
export function AdminSidebar() {
  ...
  return (
    <aside
      aria-label={t("navigation.adminSidebar.menuLabel")}
    ...
    >
      ...
      {/* Navigation groups */}
      <nav
        aria-label={t("navigation.adminSidebar.navLabel")}
          ...
          return (
            <div key={group} className="mb-1">
              ...
              <div
                id={groupId}
                role="list"
                aria-label={`${t("navigation.adminSidebar.groupPrefix")} ${t(group)}`}
                className={cn(
      ...
      <div className="px-3 pb-4 border-t border-neutral-200 dark:border-neutral-800 pt-3">
        ...
        >
          <LogOut
            ...
            aria-hidden="true"
          />
          {t("navigation.adminSidebar.signOut")}
        </button>
      </div>
    </aside>
  );
