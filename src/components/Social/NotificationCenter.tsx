                    ...
                    >
                        ...
                        <div className="px-4 py-3 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
                            <div>
                                ...
                                <p className="text-[10px] text-slate-500">Anda memiliki {unreadCount} pesan belum dibaca</p>
                            </div>
                            {unreadCount > 0 && (
                                <button
                        ...
                        <div className="max-h-[400px] overflow-y-auto">
                            {loading && notifications.length === 0 ? (
                                ...
                                <div className="p-12 text-center">
                                    ...
                                    <p className="text-slate-500 text-xs">Semua notifikasi baru akan muncul di sini.</p>
                                </div>
                            ) : (
            ...
            <div className="flex gap-4">
                ...
                <div className="flex-1 space-y-1">
                    <div className="flex justify-between items-start gap-2">
                        <h4 className={cn("text-sm transition-colors", notification.is_read ? "text-slate-600" : "font-bold text-slate-900 group-hover:text-blue-600")}>
                            {notification.title}
                        </h4>
