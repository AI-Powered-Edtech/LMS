        ...
        case 'DELETE_MODULE':
            return {
                ...
                activeLesson: state.activeLesson &&
                    state.modules.find(m => m.id === action.moduleId)?.lessons.some(l => l.id === state.activeLesson?.id)
                    ? null : state.activeLesson,
            };
        case 'ADD_LESSON':
            return {
                ...state,
...
interface BuilderContextValue {
    ...
    actions: {
        ...
        updateModule: (moduleId: string, data: { title?: string; description?: string }) => Promise<void>;
