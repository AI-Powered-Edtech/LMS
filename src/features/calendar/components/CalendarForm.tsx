...
type CalendarFormData = v.InferOutput<typeof schema>
...
/**
 * Form untuk membuat/mengedit Kalender.
 */
export function CalendarForm({ onSubmit, isLoading, className }: CalendarFormProps) {
  const { control, handleSubmit } = useForm<CalendarFormData>({
