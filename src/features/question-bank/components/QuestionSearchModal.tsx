            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
                ...
                >
                    ...
                    <div className="flex items-center justify-between p-5 border-b border-slate-200 dark:border-slate-700">
                        <div>
                            <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">Cari dari Bank Soal</h2>
                            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Pilih soal untuk ditambahkan ke kuis ini.</p>
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <div className="flex-1 overflow-y-auto p-5 bg-slate-50/50 dark:bg-slate-900/20">
                        {loading && questions.length === 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-20 text-slate-400 border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-2xl mx-10">
                                ...
                                <h3 className="text-base font-semibold text-slate-600 dark:text-slate-300">Tidak ada hasil</h3>
