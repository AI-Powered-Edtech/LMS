...
interface QuestionBankTableProps<T extends Record<string, unknown>> {
  columns: Column<T>[]
  data: T[]
  isLoading?: boolean
  className?: string
...
/**
 * Tabel data untuk Bank Soal.
 */
export function QuestionBankTable<T extends Record<string, unknown>>({
  columns,
  data,
  isLoading,
  className,
}: QuestionBankTableProps<T>) {
  return (
    <div
      className={cn(
