...
type DiscussionFormData = v.InferOutput<typeof schema>
...
/**
 * Form untuk membuat/mengedit Diskusi.
 */
export function DiscussionForm({ onSubmit, isLoading, className }: DiscussionFormProps) {
  const { control, handleSubmit } = useForm<DiscussionFormData>({
