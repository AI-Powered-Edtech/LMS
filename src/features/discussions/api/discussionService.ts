...
export const discussionService = {
     ...
     */
    async saveDiscussion(discussion: Partial<Discussion> & { tenant_id: string; author_id: string; content: string }) {
     ...
     */
    subscribe(contextId: string, contextType: 'announcement' | 'lesson' | 'course', callback: (payload: any) => void) {
