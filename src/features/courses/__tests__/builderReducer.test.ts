// MOVED: This test has been relocated to src/features/course-builder/__tests__/builderReducer.test.ts
...
import type { BuilderState } from '../builder/builderReducer'
import { builderReducer, initialBuilderState } from '../builder/builderReducer'
