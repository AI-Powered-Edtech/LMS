...
export type ArtifactKind = 'outline' | 'lesson_draft' | 'assessment' | 'transform'
...
export type CopilotTab = 'outline' | 'lesson_draft' | 'assessment' | 'improve' | 'history'

// ─── Launch Context ──────────────────────────────────────────────────────────

export interface CopilotLaunchContext {
  entryPoint: 'topbar' | 'sidebar_empty' | 'lesson_empty' | 'block_action' | 'release_panel'
