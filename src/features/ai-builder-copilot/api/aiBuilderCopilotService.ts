...
const ERROR_MAP: Record<string, string> = {
  ...
  CONTENT_TOO_SHORT:
    "Konten terlalu pendek untuk diproses (minimal 10 karakter).",
  ...
  COURSE_TITLE_TOO_LONG:
    "Judul kursus terlalu panjang. Maksimal 5.000 karakter.",
  COURSE_DESCRIPTION_TOO_LONG:
    "Deskripsi kursus terlalu panjang. Maksimal 5.000 karakter.",
  SUBJECT_TOO_LONG: "Mata pelajaran terlalu panjang. Maksimal 5.000 karakter.",
  GRADE_LEVEL_TOO_LONG:
    "Tingkat kelas terlalu panjang. Maksimal 5.000 karakter.",
  LESSON_TITLE_TOO_LONG:
    "Judul pelajaran terlalu panjang. Maksimal 5.000 karakter.",
};
...
export const aiBuilderCopilotService = {
  ...
  async generateLessonDraft(
    ...
    const hasQuizPayload =
      !!draft?.quiz_payload && typeof draft.quiz_payload === "object";
    const hasAssignmentPayload =
      !!draft?.assignment_payload &&
      typeof draft.assignment_payload === "object";
    ...
    return {
      ...
      draft: {
        blocks: hasBlocks
          ? (draft!.blocks as import("../types").LessonDraftBlock[])
          : [],
        ...
        assignment_payload: hasAssignmentPayload
          ? (draft!
              .assignment_payload as import("../types").AssignmentDraftPayload)
          : undefined,
      },
    };
  },
