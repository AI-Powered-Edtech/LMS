 ...
 */
export function usePeerReviewConfig(assignmentId: string | null | undefined, tenantId: string) {
  return useQuery({
    queryKey: peerReviewQueryKeys.byAssignment(tenantId, assignmentId ?? ''),
    queryFn: () => peerReviewService.getConfigByAssignment(assignmentId!, tenantId),
 ...
 */
export function useMyPeerReviews(userId: string | null | undefined, tenantId: string) {
  return useQuery({
 ...
 */
export function useReviewsBySubmission(submissionId: string | null | undefined, tenantId: string) {
  return useQuery({
    queryKey: peerReviewQueryKeys.bySubmission(tenantId, submissionId ?? ''),
    queryFn: () => peerReviewService.getReviewsBySubmission(submissionId!, tenantId),
