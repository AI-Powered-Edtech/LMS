                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
                          <div
                            className="p-1.5 rounded-lg text-blue-500 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-colors"
                            title="Muat kembali"
                          >
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-lg text-red-400 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors"
                            title="Hapus riwayat"
