...
type StorageFormData = v.InferOutput<typeof schema>
...
/**
 * Form untuk membuat/mengedit Penyimpanan.
 */
export function StorageForm({ onSubmit, isLoading, className }: StorageFormProps) {
  const { control, handleSubmit } = useForm<StorageFormData>({
