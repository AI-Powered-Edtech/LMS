 ...
 */
export function useRubricByAssignment(
  ...
  return useQuery({
    ...
    queryFn: () =>
      rubricService.getRubricByAssignment(assignmentId!, tenantId!),
 ...
 */
export function useRubricScores(
...
export function useSaveRubric() {
  ...
  return useMutation({
    mutationFn: (rubric: RubricInsert & { id?: string }) =>
