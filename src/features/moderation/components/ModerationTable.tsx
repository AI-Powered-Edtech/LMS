...
interface ModerationTableProps<T extends Record<string, unknown>> {
  columns: Column<T>[]
  data: T[]
  isLoading?: boolean
  className?: string
...
/**
 * Tabel data untuk Moderasi.
 */
export function ModerationTable<T extends Record<string, unknown>>({
  columns,
  data,
  isLoading,
  className,
