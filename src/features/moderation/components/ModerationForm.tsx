...
type ModerationFormData = v.InferOutput<typeof schema>
...
/**
 * Form untuk membuat/mengedit Moderasi.
 */
export function ModerationForm({ onSubmit, isLoading, className }: ModerationFormProps) {
  const { control, handleSubmit } = useForm<ModerationFormData>({
