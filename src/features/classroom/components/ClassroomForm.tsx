...
type ClassroomFormData = v.InferOutput<typeof schema>
...
/**
 * Form untuk membuat/mengedit Kelas.
 */
export function ClassroomForm({ onSubmit, isLoading, className }: ClassroomFormProps) {
  const { control, handleSubmit } = useForm<ClassroomFormData>({
