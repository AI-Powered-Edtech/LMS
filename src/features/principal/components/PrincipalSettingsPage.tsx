...
function settingsToForm(
  settings: PrincipalSettings | null | undefined,
): SettingsFormState {
  ...
  return {
    ...
    report_frequency:
      (settings.report_schedule as ReportSchedulerState["frequency"]) ??
      "monthly",
...
function getNextReportDate(
  frequency: ReportSchedulerState["frequency"],
): string {
  const now = new Date();
  ...
  if (frequency === "quarterly") {
    ...
    const nextYear =
      nextQuarterMonth >= 12 ? now.getFullYear() + 1 : now.getFullYear();
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <section className="rounded-2xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-900 p-6">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
            Tanggal mulai menggunakan LMS. Digunakan untuk kalkulasi
            perbandingan sebelum/sesudah LMS.
          </p>
          <Input
            ...
            onChange={(e) =>
              setForm((prev) => ({ ...prev, baseline_date: e.target.value }))
            }
          />
        </section>
          ...
          <div className="flex items-center justify-between p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 mb-5">
            ...
            <button
              ...
              onClick={() =>
                setForm((prev) => ({
                  ...prev,
                  report_enabled: !prev.report_enabled,
                }))
              }
          ...
          <div className="space-y-4">
            ...
            <Select
              ...
              onChange={(e) =>
                setForm((prev) => ({
                  ...prev,
                  report_frequency: e.target
                    .value as ReportSchedulerState["frequency"],
                }))
              }
            />
            ...
            {form.report_enabled && (
              <div className="p-3 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/30">
                <p className="text-sm text-blue-700 dark:text-blue-300 font-medium">
                  📅 Laporan berikutnya akan dikirim pada{" "}
