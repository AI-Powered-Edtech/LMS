...
type AssignmentFormData = v.InferOutput<typeof schema>
...
/**
 * Form untuk membuat/mengedit Tugas.
 */
export function AssignmentForm({ onSubmit, isLoading, className }: AssignmentFormProps) {
