...
interface GradebookEmptyStateProps {
  message?: string
...
/**
 * Empty state untuk Buku Nilai saat tidak ada data.
 */
export function GradebookEmptyState({
  message = 'Belum ada data buku nilai',
  action,
  className,
}: GradebookEmptyStateProps) {
  return (
    <div
      className={cn(
