...
function getTypeLabel(type: string): string {
  return i18n.t(`gradebookMobile.types.${type}`, { defaultValue: type });
}
...
function StudentCard({
  ...
  const average =
    gradedAssignments.length > 0
      ? totalPercentage / gradedAssignments.length
      : 0;
  ...
  return (
    ...
    >
            ...
            <div className="flex-1 min-w-0">
              ...
              {student.nis && (
                <p className="text-xs text-slate-500 dark:text-slate-400">
                  {t("gradebookMobile.nis").replace("__NIS__", student.nis)}
                </p>
              )}
              {student.email && (
      ...
      <div className="p-4">
        ...
        >
          <span>
            {t("gradebookMobile.gradeAssignments").replace(
              "__COUNT__",
                        ...
                        {editingId === assignment.id ? (
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {onEditGrade && (
                              <button
                                onClick={() =>
                                  handleEdit(assignment.id, entry.score)
                                }
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <p className="text-slate-600 dark:text-slate-400">
          {t("gradebookMobile.noStudentsFound")}
        </p>
      </div>
    );
  }
