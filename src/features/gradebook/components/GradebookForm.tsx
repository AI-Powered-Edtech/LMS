...
type GradebookFormData = v.InferOutput<typeof schema>
...
/**
 * Form untuk membuat/mengedit Buku Nilai.
 */
export function GradebookForm({ onSubmit, isLoading, className }: GradebookFormProps) {
  const { control, handleSubmit } = useForm<GradebookFormData>({
