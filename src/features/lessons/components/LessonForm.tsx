...
type LessonFormData = v.InferOutput<typeof schema>
...
/**
 * Form untuk membuat/mengedit Pelajaran.
 */
export function LessonForm({ onSubmit, isLoading, className }: LessonFormProps) {
