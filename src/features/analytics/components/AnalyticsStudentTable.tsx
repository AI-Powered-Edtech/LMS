            ...
            {filteredStudents.length > 0 ? (
              filteredStudents.map((student) => {
                ...
                if (student.last_active) {
                  const diffMs =
                    new Date().getTime() -
                    new Date(student.last_active).getTime();
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-center">
                        <span
                          className={cn(
                            ...
                            relativeDate === "-" ||
                              (relativeDate.includes("hari lalu") &&
                                parseInt(relativeDate) > 7)
                      ...
                      <td className="px-6 py-4 text-right">
                        <button
                          ...
                          aria-label={`Lihat detail log ${student.name}`}
                        >
                            ...
                            <div className="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-700 text-sm shadow-sm flex items-start gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-slate-600 dark:text-slate-400 mb-3">
                                  ...
                                  {Math.round(student.progress)}%. Disarankan
                                  untuk menghubungi siswa melalui fitur pesan
                                  atau melakukan check-in pada sesi berikutnya.
                                </p>
                                <button
                                  onClick={() =>
                                    addToast({
                                      type: "warning",
                                      message:
                                        "Fitur kirim pesan otomatis dalam pengembangan",
                                    })
                                  }
