...
function riskBg(risk: number) {
    ...
    if (risk >= 0.4) return 'bg-amber-50 dark:bg-amber-900/10 border-amber-200 dark:border-amber-900/40';
                        ...
                        <div>
                            ...
                            <div className="mt-1 h-1.5 w-full rounded-full bg-slate-200 dark:bg-slate-700">
                                <div
                                    className={cn(
                                        'h-1.5 rounded-full',
                                        prediction.churn_risk >= 0.7 ? 'bg-red-500' :
                                        prediction.churn_risk >= 0.4 ? 'bg-amber-500' : 'bg-emerald-500'
                                    )}
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-1.5">
                                ...
                                <span className="text-sm font-medium text-slate-700 dark:text-slate-300 capitalize">
                                    {prediction.session_trend === 'declining' ? 'Menurun'
                                        : prediction.session_trend === 'rising' ? 'Meningkat'
                                        : 'Stabil'}
                                </span>
                            </div>
