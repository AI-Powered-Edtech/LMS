    ...
    return (
        <div className="space-y-4 rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
            ...
            {isLoading ? (
                ...
                <p className="py-8 text-center text-sm text-slate-400">Belum ada data retensi. Data akan muncul setelah siswa mengakses pelajaran selama beberapa minggu.</p>
            )}
        </div>
    );
}
