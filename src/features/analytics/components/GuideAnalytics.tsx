    ...
    return (
        <div className="rounded-xl border border-slate-200 bg-white p-5 dark:border-slate-700 dark:bg-slate-900">
            ...
            <div className="mb-4 flex items-center justify-between">
                ...
                <button
                    onClick={() => { setEditingGuide(null); setShowBuilder(true); }}
                    ...
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="border-b border-slate-100 dark:border-slate-800">
                                <th className="pb-2 pr-3 text-left font-medium text-slate-500 dark:text-slate-400">Judul</th>
                                <th className="pb-2 pr-3 text-left font-medium text-slate-500 dark:text-slate-400 hidden sm:table-cell">Tipe</th>
                                <th className="pb-2 pr-3 text-left font-medium text-slate-500 dark:text-slate-400 hidden md:table-cell">Segmen</th>
                                <th className="pb-2 pr-3 text-right font-medium text-slate-500 dark:text-slate-400">Tampil</th>
                                <th className="pb-2 pr-3 text-right font-medium text-slate-500 dark:text-slate-400">Tutup</th>
                                <th className="pb-2 text-right font-medium text-slate-500 dark:text-slate-400">Selesai</th>
                                <th className="pb-2" />
                            </tr>
                        </thead>
                        <tbody>
