...
function riskLabel(risk: number) {
    if (risk >= 0.7) return { text: 'Tinggi', cls: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300' };
    if (risk >= 0.4) return { text: 'Sedang', cls: 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300' };
    return { text: 'Rendah', cls: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300' };
}
                        ...
                        return (
                            <div key={student.user_id}>
                                ...
                                >
                                    ...
                                    <span className={cn(
                                        'text-sm font-bold',
                                        student.churn_risk >= 0.7 ? 'text-red-600 dark:text-red-400' :
                                        student.churn_risk >= 0.4 ? 'text-amber-600 dark:text-amber-400' :
