...
interface OnboardingTableProps<T extends Record<string, unknown>> {
  columns: Column<T>[]
  data: T[]
  isLoading?: boolean
  className?: string
...
/**
 * Tabel data untuk Onboarding.
 */
export function OnboardingTable<T extends Record<string, unknown>>({
  columns,
  data,
  isLoading,
  className,
}: OnboardingTableProps<T>) {
  return (
    <div
      className={cn(
