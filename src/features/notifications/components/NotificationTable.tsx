...
interface NotificationTableProps<T extends Record<string, unknown>> {
  columns: Column<T>[]
  data: T[]
  isLoading?: boolean
  className?: string
...
/**
 * Tabel data untuk Notifikasi.
 */
export function NotificationTable<T extends Record<string, unknown>>({
  columns,
  data,
  isLoading,
  className,
}: NotificationTableProps<T>) {
  return (
    <div
      className={cn(
