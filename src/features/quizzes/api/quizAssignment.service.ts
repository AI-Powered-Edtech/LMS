 ...
 */
export async function updateQuizAssignment(assignmentId: string, updates: Record<string, unknown>, tenantId: string) {
  // Normalize available_until -> due_at if needed
