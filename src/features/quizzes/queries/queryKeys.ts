...
export const QuizKeys = {
  ...
  // Student queries
  studentAssignments: (tenantId: string) => [...base.all(tenantId), 'studentAssignments'] as const,

  userAttempts: (tenantId: string) => [...base.all(tenantId), 'userAttempts'] as const,
  ...
  // Teacher queries
  teacherQuizzes: (tenantId: string) => [...base.all(tenantId), 'teacherQuizzes'] as const,
