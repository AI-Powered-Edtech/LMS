          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                onChange={(e) =>
                  onUpdateQuestionType(qIdx, e.target.value as QuestionType)
                }
              ...
              <div className="flex items-center gap-2 px-3 py-2 bg-slate-50 dark:bg-slate-700 border border-slate-100 dark:border-slate-600 rounded-xl">
                <input
                  ...
                  value={q.points ?? 1}
                  onChange={(e) =>
                    onUpdateQuestionPoints(qIdx, parseInt(e.target.value) || 1)
                  }
                  disabled={isPublished}
                ...
                <div className="pl-8 space-y-2">
                  ...
                  {q.options.map((opt, oIdx) => (
                    <div key={oIdx} className="flex items-center gap-2">
                      <button
                        onClick={() =>
                          !isPublished && onSetCorrectOption(qIdx, oIdx)
                        }
                        disabled={isPublished}
                        title={
                          opt.is_correct
                      ...
                      <input
                        ...
                        value={opt.text}
                        onChange={(e) =>
                          onUpdateOption(qIdx, oIdx, e.target.value)
                        }
                        disabled={
