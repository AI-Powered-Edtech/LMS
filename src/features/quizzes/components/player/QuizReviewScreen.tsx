          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 dark:text-amber-400 mt-1">
                Sebaiknya Anda menjawab semua soal. Klik nomor soal di bawah
        ...
        <div className="max-h-80 overflow-y-auto space-y-2 pr-1">
          {questions.map((q, i) => {
            ...
            if (!isAnswered) {
              ...
              const selectedIds =
                answers[q.question_id]?.selected_option_ids || [];
              const selectedOptions =
                q.quiz_options?.filter((opt: QuizOptionSnapshot) =>
                  selectedIds.includes(opt.id),
                ) || [];
              answerPreview = selectedOptions
                .map((opt: QuizOptionSnapshot) => opt.text)
                .join(", ");
            }
        ...
        {showConfirm && (
          ...
          >
            ...
            <p className="text-sm text-red-600 dark:text-red-400 mb-6">
              Anda masih memiliki soal yang belum dijawab. Jawaban tidak dapat
              diubah setelah kuis dikirim.
            </p>
