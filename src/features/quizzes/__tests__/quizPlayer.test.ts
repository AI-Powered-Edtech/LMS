...
describe('startQuizAttempt', () => {
  ...
  it('calls v1_start_quiz_attempt RPC', async () => {
    ...
    expect(mockRpc).toHaveBeenCalledWith('v1_start_quiz_attempt', expect.objectContaining({
      p_quiz_id: 'quiz-1',
    }));
  });
...
describe('submitQuizAttempt', () => {
  ...
  it('calls v1_submit_quiz_attempt RPC', async () => {
    ...
    expect(mockRpc).toHaveBeenCalledWith('v1_submit_quiz_attempt', expect.objectContaining({
