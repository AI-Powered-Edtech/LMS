...
type AdministrationFormData = v.InferOutput<typeof schema>
...
/**
 * Form untuk membuat/mengedit Administrasi.
 */
export function AdministrationForm({ onSubmit, isLoading, className }: AdministrationFormProps) {
  const { control, handleSubmit } = useForm<AdministrationFormData>({
