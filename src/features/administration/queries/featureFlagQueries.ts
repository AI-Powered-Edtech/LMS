...
import { administrationService, type TenantModuleConfig } from '../api/administrationService'
...
const adminKeys = {
  ...
  featureFlags: (tenantId: string) => [...base.all(tenantId), 'feature-flags'] as const,
}
