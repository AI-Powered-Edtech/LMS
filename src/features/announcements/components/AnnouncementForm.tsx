...
type AnnouncementFormData = v.InferOutput<typeof schema>
...
/**
 * Form untuk membuat/mengedit Pengumuman.
 */
export function AnnouncementForm({ onSubmit, isLoading, className }: AnnouncementFormProps) {
