...
interface AnnouncementTableProps<T extends Record<string, unknown>> {
  columns: Column<T>[]
  data: T[]
  isLoading?: boolean
  className?: string
...
/**
 * Tabel data untuk Pengumuman.
 */
export function AnnouncementTable<T extends Record<string, unknown>>({
  columns,
  data,
  isLoading,
  className,
}: AnnouncementTableProps<T>) {
  return (
    <div
      className={cn(
