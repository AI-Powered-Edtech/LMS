...
interface StruggleTableProps<T extends Record<string, unknown>> {
  columns: Column<T>[]
  data: T[]
  isLoading?: boolean
  className?: string
...
/**
 * Tabel data untuk Deteksi Kesulitan.
 */
export function StruggleTable<T extends Record<string, unknown>>({
  columns,
  data,
  isLoading,
  className,
}: StruggleTableProps<T>) {
  return (
    <div
      className={cn(
