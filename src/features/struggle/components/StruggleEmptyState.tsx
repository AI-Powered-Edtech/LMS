...
interface StruggleEmptyStateProps {
  message?: string
...
/**
 * Empty state untuk Deteksi Kesulitan saat tidak ada data.
 */
export function StruggleEmptyState({
  message = 'Belum ada data deteksi kesulitan',
  action,
  className,
}: StruggleEmptyStateProps) {
  return (
    <div
      className={cn(
