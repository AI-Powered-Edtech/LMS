...
export function useCreatePathRule() {
  ...
  return useMutation({
    ...
    onError: () => {
      addToast({
        type: "error",
        message: "Gagal membuat aturan jalur. Silakan coba lagi.",
      });
    },
  });
}
...
export function useUpdatePathRule() {
  ...
  return useMutation({
    ...
    onSuccess: (updated, { tenantId }) => {
      ...
      addToast({
        type: "success",
        message: "Aturan jalur berhasil diperbarui.",
      });
    },
    onError: () => {
      addToast({
        type: "error",
        message: "Gagal memperbarui aturan jalur. Silakan coba lagi.",
      });
    },
  });
}
...
export function useDeletePathRule() {
  ...
  return useMutation({
    ...
    onError: () => {
      addToast({
        type: "error",
        message: "Gagal menghapus aturan jalur. Silakan coba lagi.",
      });
    },
  });
}
...
export function useEvaluateNextLesson(
  ...
  return useQuery({
    ...
    queryFn: () =>
      adaptivePathService.evaluateNextLesson(
        userId!,
        courseId!,
        lessonId!,
        tenantId!,
