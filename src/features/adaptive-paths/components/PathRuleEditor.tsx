...
export function PathRuleEditor({
  ...
  const validate = (): boolean => {
    ...
    if (!form.source_lesson_id)
      newErrors.source_lesson_id = "Pilih pelajaran sumber.";
    if (!form.target_lesson_id)
      newErrors.target_lesson_id = "Pilih pelajaran target.";
    if (form.source_lesson_id === form.target_lesson_id) {
      newErrors.target_lesson_id =
        "Pelajaran sumber dan target tidak boleh sama.";
    }
    if (showScoreField) {
          ...
          >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, source_lesson_id: e.target.value }))
                }
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, target_lesson_id: e.target.value }))
                }
                className={inputClass}
              >
                <option value="">-- Pilih pelajaran --</option>
            ...
            <div className="flex items-center justify-between py-1">
              <span className={labelClass.replace("mb-1.5", "mb-0")}>
                Aktif
              </span>
              <button
                type="button"
