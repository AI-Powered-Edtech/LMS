...
interface AITutorDetailViewProps {
  title: string
  fields: DetailField[]
...
/**
 * Detail view untuk menampilkan informasi lengkap AI Tutor.
 */
export function AITutorDetailView({ title, fields, actions, className }: AITutorDetailViewProps) {
  return (
    <div
      className={cn(
