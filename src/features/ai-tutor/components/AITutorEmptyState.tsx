...
interface AITutorEmptyStateProps {
  message?: string
...
/**
 * Empty state untuk AI Tutor saat tidak ada data.
 */
export function AITutorEmptyState({
  message = 'Belum ada data ai tutor',
  action,
  className,
}: AITutorEmptyStateProps) {
  return (
    <div
      className={cn(
