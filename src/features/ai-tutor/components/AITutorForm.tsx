...
type AITutorFormData = v.InferOutput<typeof schema>
...
/**
 * Form untuk membuat/mengedit AI Tutor.
 */
export function AITutorForm({ onSubmit, isLoading, className }: AITutorFormProps) {
  const { control, handleSubmit } = useForm<AITutorFormData>({
