...
interface RecommendationTableProps<T extends Record<string, unknown>> {
  columns: Column<T>[]
  data: T[]
  isLoading?: boolean
  className?: string
...
/**
 * Tabel data untuk Rekomendasi.
 */
export function RecommendationTable<T extends Record<string, unknown>>({
  columns,
  data,
  isLoading,
  className,
}: RecommendationTableProps<T>) {
  return (
    <div
      className={cn(
