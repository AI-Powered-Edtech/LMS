...
const TYPE_ACCENTS: Record<RecommendationType, string> = {
  ...
  practice_weak_topic:
    "border-l-4 border-orange-500 bg-orange-50/30 dark:bg-orange-950/20",
  take_break:
    "border-l-4 border-purple-500 bg-purple-50/30 dark:bg-purple-950/20",
  continue_course:
    "border-l-4 border-green-500 bg-green-50/30 dark:bg-green-950/20",
};
