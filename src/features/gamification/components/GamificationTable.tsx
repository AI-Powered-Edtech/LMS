...
interface GamificationTableProps<T extends Record<string, unknown>> {
  columns: Column<T>[]
  data: T[]
  isLoading?: boolean
  className?: string
...
/**
 * Tabel data untuk Gamifikasi.
 */
export function GamificationTable<T extends Record<string, unknown>>({
  columns,
  data,
  isLoading,
  className,
}: GamificationTableProps<T>) {
  return (
    <div
      className={cn(
