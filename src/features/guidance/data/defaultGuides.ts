...
const WELCOME_DASHBOARD_GUIDE: Omit<
  LearningGuide,
  'id' | 'total_impressions' | 'total_dismissals' | 'total_completions' | 'created_at'
> = {
...
export const DEFAULT_GUIDES = [WELCOME_DASHBOARD_GUIDE, LESSON_VIEWER_INTRO_GUIDE] as const
