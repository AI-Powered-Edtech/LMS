 ...
 */
export const WELCOME_DASHBOARD_GUIDE: Omit<LearningGuide, 'id' | 'total_impressions' | 'total_dismissals' | 'total_completions' | 'created_at'> = {
 ...
 */
export const LESSON_VIEWER_INTRO_GUIDE: Omit<LearningGuide, 'id' | 'total_impressions' | 'total_dismissals' | 'total_completions' | 'created_at'> = {
