...
interface GuidanceTableProps<T extends Record<string, unknown>> {
  columns: Column<T>[]
  data: T[]
  isLoading?: boolean
  className?: string
...
/**
 * Tabel data untuk Panduan.
 */
export function GuidanceTable<T extends Record<string, unknown>>({
  columns,
  data,
  isLoading,
  className,
}: GuidanceTableProps<T>) {
  return (
    <div
      className={cn(
