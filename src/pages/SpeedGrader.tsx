...
export function SpeedGrader() {
  ...
  const [_hasAccess, setHasAccess] = useState<boolean | null>(null)
        ...
        <div className="flex items-center justify-between w-full md:w-auto gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 bg-slate-100 hover:bg-slate-200 disabled:opacity-50 rounded-lg transition-colors"
            >
              ...
              >
                <div className="border-b border-slate-200 pb-6 mb-6">
                  <h2 className="text-2xl font-serif font-bold text-slate-900">
                    Dampak Artificial Intelligence terhadap Lapangan Pekerjaan
                  </h2>
                ...
                <div className="prose prose-slate font-serif leading-loose text-slate-800 max-w-none">
                  {submissionText ? (
                    ...
                    <>
                      <p>
                        Perkembangan Artificial Intelligence (AI) dalam dekade terakhir telah memicu
                        perdebatan sengit mengenai masa depan lapangan pekerjaan. Di satu sisi,
                        banyak yang khawatir bahwa mesin akan menggantikan peran manusia dalam
                        berbagai sektor industri.
                      </p>
                      <p>
                        Namun, sejarah menunjukkan bahwa setiap revolusi industri selalu menciptakan
                        jenis pekerjaan baru yang sebelumnya tidak pernah terbayangkan. Misalnya,
                        munculnya profesi seperti <em>Prompt Engineer</em> atau{' '}
                        <em>AI Ethics Officer</em>.
                      </p>
                      <p>
                        Pendidikan memainkan peran penting dalam mempersiapkan generasi mendatang
                        untuk menghadapi perubahan ini. Kurikulum harus beradaptasi untuk
                        mengajarkan keterampilan yang tidak mudah diotomatisasi, seperti pemikiran
                        kritis, kreativitas, dan kecerdasan emosional.
                      </p>
                      <p>
                        Oleh karena itu, AI tidak akan menggantikan manusia, melainkan manusia yang
                        menggunakan AI akan menggantikan manusia yang tidak menggunakannya.
                        Kolaborasi antara kecerdasan buatan dan kecerdasan manusia adalah kunci
              ...
              <div>
                ...
                <span
                  className={cn(
                    ...
                    currentStudent.gradeEntry.status === 'graded'
                      ? 'bg-green-100 text-green-700'
                      : currentStudent.gradeEntry.status === 'needs_revision'
