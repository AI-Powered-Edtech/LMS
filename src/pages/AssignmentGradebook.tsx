    ...
    return (
        <div className="p-6 lg:p-10 max-w-7xl mx-auto space-y-8">
            ...
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Assignment Gradebook</h1>
                    <p className="text-slate-500 mt-1">Kelola pengiriman tugas dan berikan penilaian kepada siswa.</p>
                </div>
                {!selectedAssignment && (
                                ...
                                <div className="flex items-center gap-4 mt-6 text-xs font-bold text-slate-400 uppercase tracking-widest">
                                    ...
                                    {assignment.due_date && (
                                        <span className="flex items-center gap-1.5 text-rose-500">
                                            ...
                                            {new Date(assignment.due_date).toLocaleDateString('id-ID', { day: 'numeric', month: 'short' })}
                                        </span>
                                    )}
                                </div>
                            </motion.button>
                        ...
                        >
                            ...
                            <div className="flex-1 overflow-auto p-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-4">
                                    <h4 className="text-sm font-bold text-slate-900 uppercase tracking-widest px-1">Hasil Pekerjaan Siswa</h4>
                                ...
                                {/* Grading Form */}
                                <div className="space-y-6">
                                    <h4 className="text-sm font-bold text-slate-900 uppercase tracking-widest px-1">Berikan Penilaian</h4>

                                    <div className="space-y-2">
                                        <label className="text-xs font-bold text-slate-500 uppercase flex justify-between">
                                            Skor (0 - {selectedAssignment?.max_points})
                                            <span className="text-blue-600">{score} / {selectedAssignment?.max_points}</span>
                                        </label>
                                        <input
                                            type="number"
                                            min="0"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Umpan Balik (Feedback)</label>
                                        <textarea
                                            value={feedback}
                                    ...
                                    >
                                        {isSubmittingGrade ? <Loader2 className="w-5 h-5 animate-spin" /> : <Send className="w-5 h-5" />}
                                        Kirim Penilaian
                                    </button>
                                </div>
                            </div>
