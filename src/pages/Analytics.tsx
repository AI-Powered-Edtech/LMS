                    ...
                    {filteredStudents.length > 0 ? (
                      filteredStudents.map((student) => {
                        ...
                        if (student.last_active) {
                          const diffMs =
                            new Date().getTime() - new Date(student.last_active).getTime()
                                    ...
                                    <div className="bg-white p-4 rounded-xl border border-slate-200 text-sm shadow-sm flex items-start gap-3">
                                      ...
                                      <div>
                                        <p className="font-semibold text-slate-800 mb-1">
                                          ...
                                          {isKritis ? 'sangat tertinggal' : 'sedikit tertinggal'}{' '}
                                          dari target kelas.
                                        </p>
                                        <p className="text-slate-600 mb-3">
                                          Tingkat penyelesaian kursus:{' '}
                                          {Math.round(student.progress)}%. Disarankan untuk
                                          menghubungi siswa melalui fitur pesan atau melakukan
                                          check-in pada sesi berikutnya.
                                        </p>
