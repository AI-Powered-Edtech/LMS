...
export const Courses: React.FC = () => {
  ...
  // ⚡ Bolt: Memoize the flattened array to prevent re-creating the array reference
  // on every render when data?.pages hasn't changed.
  ...
  // ⚡ Bolt: Memoize filtered results to avoid O(N) recalculations on unrelated re-renders.
