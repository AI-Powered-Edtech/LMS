...
export const Courses: React.FC = () => {
  ...
  // ⚡ Bolt Perf: Memoize the flattened course list to prevent O(N) array recreation on every render
  ...
  // ⚡ Bolt Perf: Memoize filtered results and hoist static `.toLowerCase()` outside the loop
