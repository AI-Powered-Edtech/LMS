...
export const Courses: React.FC = () => {
  ...
  // ⚡ Bolt Optimization: Memoize the derived array to prevent recreating the reference on every render,
  // which would otherwise break downstream memoization in child components.
