                    ...
                    <AnimatePresence>
                        {filteredCourses.map((course, idx) => (
                            <CourseCard
                                ...
                                onAssign={() => setAssignModal({ isOpen: true, courseId: course.id, courseTitle: course.title })}
                            />
                        ))}
                    </AnimatePresence>
                </div>
...
function CourseCard({ course, idx, gradientClass, onNavigate, onAssign }: CourseCardProps) {
    ...
    return (
        ...
        >
            ...
            <div className={cn('h-40 bg-gradient-to-br relative p-6 flex flex-col justify-end overflow-hidden', gradientClass)}>
                {/* decorative blobs */}
            ...
            <div className="p-5">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700/60">
                    <div className="flex items-center text-gray-400 dark:text-gray-500 text-xs font-medium gap-1.5">
                        ...
                        <span>
                            {new Date(course.updated_at || '').toLocaleDateString('id-ID', { day: 'numeric', month: 'short', year: 'numeric' })}
                        </span>
                    </div>
