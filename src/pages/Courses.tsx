...
export const Courses: React.FC = () => {
  ...
  // Bolt: Memoize array derivation from React Query to prevent recreating reference on every render
  ...
  // Bolt: Memoize filtered results and hoist static `.toLowerCase()` outside the loop
