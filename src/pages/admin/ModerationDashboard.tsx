        ...
        <div className="flex items-center gap-2 bg-white p-1 rounded-xl border border-slate-200 shadow-sm">
          <button
            ...
            className={cn(
              ...
              filterStatus === 'pending' ? "bg-slate-900 text-white" : "text-slate-600 hover:bg-slate-50"
            )}
          >
            Perlu Tinjauan
          </button>
          <button
            ...
            className={cn(
              "px-4 py-2 rounded-lg text-sm font-bold transition-colors",
              filterStatus === 'resolved' ? "bg-slate-900 text-white" : "text-slate-600 hover:bg-slate-50"
            )}
          >
            Selesai
          </button>
          <button
            ...
            className={cn(
              "px-4 py-2 rounded-lg text-sm font-bold transition-colors",
              filterStatus === 'all' ? "bg-slate-900 text-white" : "text-slate-600 hover:bg-slate-50"
            )}
          >
            Semua
          </button>
                  ...
                  <div className="flex-1 space-y-4">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-3">
                        <span className={cn("px-2.5 py-1 rounded-lg text-xs font-bold border uppercase tracking-wider", getStatusColor(report.status))}>
                    ...
                    <div>
                      <h3 className="font-bold text-slate-900 text-lg mb-1 flex items-center gap-2">
                        ...
                        <span className="text-slate-400 font-normal text-sm">oleh {report.reporterName}</span>
                      </h3>
