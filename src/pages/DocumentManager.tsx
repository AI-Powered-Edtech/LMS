            ...
            {file ? (
              <div className="flex items-center justify-center gap-3">
                ...
                <button
                  ...
                  className="ml-2 p-1 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
