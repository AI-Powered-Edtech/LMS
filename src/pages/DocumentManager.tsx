      ...
      <ModalBody>
        <div className="space-y-4">
          ...
          <div className="w-full">
            <label htmlFor="doc-upload-desc" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">
              ...
              <textarea
                ...
                rows={2}
                className={cn(
                  "w-full text-sm px-4 py-2.5 rounded-xl border transition-colors mt-1.5 font-normal",
