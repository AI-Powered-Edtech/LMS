      ...
      >
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            title="Perbarui Data"
          />
          <Button variant="secondary" size="sm" icon={<BookOpen className="w-4 h-4" />} onClick={navigateToCourses}>
            Materi
          </Button>
          <Button variant="primary" size="sm" icon={<Plus className="w-4 h-4" />} onClick={navigateToCreator}>
            Buat Tugas
          </Button>
        </div>
      </motion.div>
      ...
      {alerts.length > 0 && (
        ...
        >
          {alerts.map((alert) => (
            ...
            >
              <div className="flex items-center gap-3">
                <div className={cn("w-2 h-2 rounded-full", alert.urgent ? "bg-orange-500" : "bg-blue-500")} />
                <span className={cn(
                  "text-sm font-medium",
                  alert.urgent ? "text-orange-900 dark:text-orange-300" : "text-blue-900 dark:text-blue-300"
                )}>
                  {alert.message}
                </span>
              </div>
      ...
      >
        ...
        {uniqueClassrooms.length > 0 ? (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-xs font-medium text-slate-600 dark:text-slate-300">Aktif</span>
                        </div>
                      </td>
          ...
          <div className="py-12 border border-dashed border-slate-200 dark:border-slate-800 rounded-lg flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-sm font-medium text-slate-900 dark:text-white mb-1">Belum ada kelas</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Buat kelas pertamamu untuk mulai mengajar.</p>
