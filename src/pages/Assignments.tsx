...
export function Assignments() {
  ...
  const handleCreateAssignment = async (data: NewAssignmentData) => {
    try {
      ...
      if (import.meta.env.DEV) console.error('Failed to create assignment', err)
      addToast({ type: 'error', message: 'Gagal membuat tugas.' })
    }
  }
        ...
        {previewFile && (
          ...
          >
            <motion.div
              ...
              role="dialog"
              aria-modal="true"
              aria-label={`Pratinjau: ${previewFile}`}
