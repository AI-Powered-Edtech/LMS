...
- Name: rombel-adapter.spec.ts >> classSectionAdapter (Issue #324 F1) >> exports the documented contract
- Location: tests/e2e/rombel-adapter.spec.ts:36:2
...
Expected substring: "source: 'rombel' | 'classes'"
Received string:    "/**
