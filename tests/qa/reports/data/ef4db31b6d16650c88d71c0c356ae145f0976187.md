...
- Name: rombel-adapter.spec.ts >> classSectionAdapter (Issue #324 F1) >> dispatch reads rombel_members for source=rombel
- Location: tests/e2e/rombel-adapter.spec.ts:52:2
...
Expected substring: ".from('rombel_members')"
Received string:    "/**
