...
| 4   | Ibu Sari (Parent)      | `parent`    | ✅ Implemented | **P0**   |
| 5   | Dr. Widodo (Principal) | `principal` | ✅ Implemented | **P1**   |

---

---

## Phase 26-30 Completed Items

### Phase 26 — Student UX Improvements ✅

- [x] 26.1 Quiz Timer Pause/Resume — pause button, `pause_count`/`pause_remaining` columns
- [x] 26.2 File Preview Before Assignment Submit — FilePreviewModal (PDF, image, text)
- [x] 26.3 Offline Mode untuk Lessons — PWA service worker, IndexedDB cache, OfflineBanner
- [x] 26.4 Real-time Grade Data (Fix What-If Grades) — replaced dummy data dengan live fetch
- [x] 26.5 Deep Link Course Enrollment — `/#/join?code=XXXXXX`, QR code generator & scanner

### Phase 27 — Teacher UX Improvements ✅

- [x] 27.1 Guided Onboarding Wizard untuk Guru Baru — 5-step wizard, progress persistence
- [x] 27.2 SpeedGrader Annotation Persistence — `submission_annotations` table, AnnotationLayer
- [x] 27.3 CSV Export untuk Gradebook — PapaParse integration, filter by class/date range
- [x] 27.4 Activity Feed di Teacher Dashboard — live feed dari `activity_events`, auto-refresh 30s
- [x] 27.5 Question Bank Integration di Quiz Manager — import modal, multi-select, preview
- [x] 27.6 Mobile Responsiveness — Course Builder & SpeedGrader di viewport 360x640

### Phase 28 — Admin UX Improvements ✅

- [x] 28.1 Bulk User Import via CSV — 4-step wizard, batch invite via Edge Function
- [x] 28.2 Audit Log Export — CSV/PDF export dengan filter date range & action type
- [x] 28.3 Unified Feature Management — gabungkan module toggles + feature flags
- [x] 28.4 Admin Notification Center — real-time bell, types: invitation/moderation/system
- [x] 28.5 Sidebar Navigation Enhancement — grouped navigation dengan collapsible sections
- [x] 28.6 Finance Dashboard Implementation — SPP tracking, payment history, export laporan

### Phase 29 — Parent Portal ✅

- [x] 29.1 Database Schema & Role — `parent` enum, `student_parent_links`, RLS policies
- [x] 29.2 OTP-based Registration — WhatsApp OTP via Edge Function, auto-link ke siswa
- [x] 29.3 Parent Dashboard (Mobile-First) — traffic light, nilai, kehadiran, tugas
- [x] 29.4 Daily Digest via WhatsApp — Edge Function + pg_cron (17:00 WIB)
- [x] 29.5 Message Teacher Feature — in-app threading, template pesan cepat, realtime notify
- [x] 29.6 Monthly Progress Report — PDF generation, download/WhatsApp delivery

### Phase 30 — Principal Dashboard ✅

- [x] 30.1 Database Schema & Role — `principal` enum, `principal_settings`, read-only RLS
- [x] 30.2 Executive Dashboard — adoption metrics, academic overview, ROI calculator, leaderboard
- [x] 30.3 Automated Report Generation — PDF/Excel, branding sekolah, monthly schedule
- [x] 30.4 Before-After Analytics — before/after charts, export untuk yayasan/dinas
- [x] 30.5 Satisfaction Survey System — survey builder, distribusi, dashboard hasil

### System-Wide Improvements ✅

- [x] SW.1 Notification Center Enhancement — unified system semua role, Supabase Realtime
- [x] SW.2 PWA Enhancement — installable, offline-capable, background sync, push notification
- [x] SW.3 Documentation Update — USERFLOW.md, DOMAIN_MAP.md, AGENTS.md, feature docs
- [x] SW.4 Performance Optimization — React Suspense, code splitting, image lazy load, DB index
