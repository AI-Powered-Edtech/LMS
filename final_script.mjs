...
(async () => {
  ...
  try {
    execSync(`sudo -u postgres psql edusync -c "INSERT INTO tenants (id, name, slug) VALUES ('${tenantId}', 'Default Tenant', 'default') ON CONFLICT DO NOTHING;"`);
  ...
  await page.waitForTimeout(2000);
  try {
    await page.click('button:has-text("Lewati")', { timeout: 2000 });
  } catch(e) {}
